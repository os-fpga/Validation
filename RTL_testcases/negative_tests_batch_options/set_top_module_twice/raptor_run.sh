...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/accumulator.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module $design">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "set_top_module accumulator">>raptor_tcl.tcl || echo "" 
