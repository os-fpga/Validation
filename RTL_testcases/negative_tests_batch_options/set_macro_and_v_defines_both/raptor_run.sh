...
design="set_macro_and_v_defines_both"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "set_macro I2C_CMD_READ=4'b1000 I2C_CMD_WRITE=4'b0100 I2C_CMD_STOP=4'b0010 I2C_CMD_START=4'b0001 I2C_CMD_NOP=4'b0000">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_byte_ctrl.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_bit_ctrl.sv">>raptor_tcl.tcl || echo "" 
