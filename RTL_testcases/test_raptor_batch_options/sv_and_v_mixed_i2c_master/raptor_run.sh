...
design="sv_and_v_mixed_i2c_master"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl//i2c_master_defines.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl//i2c_master_byte_ctrl.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl//i2c_master_bit_ctrl.v">>raptor_tcl.tcl || echo "" 
