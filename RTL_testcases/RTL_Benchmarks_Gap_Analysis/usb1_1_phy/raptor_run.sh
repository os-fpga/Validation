...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_phy_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_rx_phy.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_tx_phy.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module usb_phy_top">>raptor_tcl.tcl 
