...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/tbench/verilog/cm0p_ik_defs.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/CM0PIKMCU.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_ahb_def_slv.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_ahb_gpio.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_ahb_interconnect.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_ahb_rom_bridge.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_ahb_sram_bridge.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_clk_gen.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_iop_gpio.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_iop_interconnect.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_misc.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_misc_delay.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_pmu.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_rom.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_rst_ctl.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_sram.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_stclken_gen.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/integration_kit/logical/cm0p_ik_mcu/verilog/cm0p_ik_sys.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_cti/verilog/CM0PCTI.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/CM0PDAP.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_ap.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_ap_cdc.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_ap_mast_defs.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_ap_mast.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_cdc.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_jtag_defs.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_jtag.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_pwr.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_sw_defs.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_dp_sw.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_dap/verilog/cm0p_dap_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/CM0PINTEGRATION.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/CM0PMTBINTEGRATION.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/CORTEXM0PLUSINTEGRATIONCS.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/cm0p_ahb_cs_rom_table.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/cm0p_csi_ahb_interconnect.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cm0p_integration/verilog/cm0p_wic.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/CORTEXM0PLUS.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_core.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_dbg_bpu.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_dbg_ctl.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_dbg_dwt.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_dbg_if.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_dbg_sel.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_matrix.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_matrix_sel.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_mpu.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_nvic.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/cortexm0plus/verilog/cm0p_top.v">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/generic/cm0p_pmu_sync_reset.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/generic/cm0p_pmu_sync_set.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/generic/cm0p_rst_send_set.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/generic/cm0p_rst_sync.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_acg.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_capt_sync.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_comb_and.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_comb_and_addr.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_comb_and_data.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_send.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_send_addr.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_send_data.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_cdc_send_reset.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_jt_cdc_comb_and.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_sw_cdc_capt_reset.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dap_sw_cdc_capt_sync.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/cells/tsmc-ce018fg-sc7_base_rvt-r9p0-01eac0/cm0p_dbg_reset_sync.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/logical/models/wrappers/CORTEXM0PLUSIMP.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module CORTEXM0PLUSINTEGRATIONCS">>raptor_tcl.tcl 
