...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./wrapper_rtl/adder_FFs.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./wrapper_rtl/wrapper_adder_FFs.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module wrapper_adder_FFs">>raptor_tcl.tcl 
