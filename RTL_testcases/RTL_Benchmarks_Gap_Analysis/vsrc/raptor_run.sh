...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/beh_lib.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mem_lib.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mem.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module mem">>raptor_tcl.tcl 
