...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sha256core/sync_fifo_fwft_infer/sdpram_infer_read_first.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sha256core/sync_fifo_fwft_infer/sync_fifo_fwft_infer.vhd">>raptor_tcl.tcl
