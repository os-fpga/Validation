...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_2p_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/edn_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/edn_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_tracer_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_cmd_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_device_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_device_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_alu.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_branch_predict.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_compressed_decoder.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_controller.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_core.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_counter.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_cs_registers.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_csr.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_decoder.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_dummy_instr.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_ex_block.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_prefetch_buffer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_fetch_fifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_icache.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_id_stage.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_if_stage.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_load_store_unit.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_lockstep.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_multdiv_fast.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_register_file_ff.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ibex_wb_stage.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_alert_sender.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_arbiter_fixed.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_arbiter_ppc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_clock_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_clock_gating.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_clock_inv.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_clock_mux2.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_count.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_diff_decode.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_edge_detector.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_edn_req.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_esc_receiver.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_fifo_async.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_fifo_async_sram_adapter.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_fifo_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_flop.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_flop_2sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_flop_en.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_clock_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_clock_inv.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_clock_mux2.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_flop_en.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_ram_1p.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_ram_2p.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_intr_hw.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_lc_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_lfsr.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_mubi4_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_packer_fifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_pulse_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_1p.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_2p.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_2p_adv.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_ram_2p_async_adv.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_reg_cdc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_sec_anchor_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_28_22_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_28_22_enc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_72_64_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_secded_72_64_enc.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_slicer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_sparse_fsm_flop.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_sram_arbiter.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_sync_reqack.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_byte_merge.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_byte_select.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_command_queue.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_core.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_data_fifos.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_fsm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_shift_register.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spi_host_window.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spid_readbuffer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spid_readsram.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spid_status.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spid_upload.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/spid_fifo2sram_adapter.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_adapter_host.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_cmd_intg_gen.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_rsp_intg_chk.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_socket_1n.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/tlul_sram_byte.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/wav_cgc_rl.sv">>raptor_tcl.tcl
    ##vary design to design
...
#reading log file of raptor to see is synthesis failed, if not failed staring the simulation
    ...
    then
        [ ! -d $design\_$tool_name\_post_synth_files ] && mkdir $design\_$tool_name\_post_synth_files
        [ -d $design\_$tool_name\_post_synth_files ] && cd $design\_$tool_name\_post_synth_files
        (cd ../../rtl && timeout 10m iverilog -g2012 -o $design $primitive_sim $sim_lib  $design_path $post_synth_netlist_path $tb_path -y $directory_path && timeout 5m vvp ./$design && mv $design tb.vcd -t ../results_dir/$design\_$tool_name\_post_synth_files) 2>&1 | tee post_synth_sim.log
