...
#creating a tcl file to run raptor flow 
    ...
    echo "target_device $design">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_alu.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_apb_interconnect.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_axi_or_tracker.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_bit_sync.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_bus_perf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_block_fetcher.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_blocks.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_flusher.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_io_fetcher.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_memctrl.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_ooo_mgt.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_prefetcher.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_cache_pusher.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_checkers.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_clint.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_control.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_control_h.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_csr.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_dcache.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_debug_h.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_decoder.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_div.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_gpios.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_h.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_icache.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_io_subsystem.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_m_ext.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_mem_router.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_memfy.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_memfy_h.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_mpu.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_pipeline.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_pmp_region.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_processing.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_pulser.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_ram.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_rambe.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_registers.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_rv32i_core.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_rv32i_platform.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_scfifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_stats.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file rtl/friscv_uart.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module friscv_rv32i_core">>raptor_tcl.tcl 
