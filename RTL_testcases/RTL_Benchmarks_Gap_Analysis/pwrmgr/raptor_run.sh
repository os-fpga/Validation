...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwm_reg_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rom_ctrl_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_clock_timeout.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr_cdc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr_fsm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr_slow_fsm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwrmgr_wake_info.sv">>raptor_tcl.tcl
