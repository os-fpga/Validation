...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tv80_alu.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tv80_core.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tv80_mcode.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tv80_reg.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tv80s_top.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module tv80s_top">>raptor_tcl.tcl 
