...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/simon_bit_serial_datapath_FPGA.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/simon_bit_serial_key_expansion_FPGA.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/simon_bit_serial_top.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module top_module">>raptor_tcl.tcl 
