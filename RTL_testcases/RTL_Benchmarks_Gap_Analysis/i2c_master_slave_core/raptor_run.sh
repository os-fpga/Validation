...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/controller_interface.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/counter.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_blk.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ms_core.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/shift.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module block">>raptor_tcl.tcl 
