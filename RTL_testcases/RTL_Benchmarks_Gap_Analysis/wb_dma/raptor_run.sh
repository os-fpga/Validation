...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_ch_arb.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_ch_pri_enc.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_ch_rf.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_ch_sel.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_de.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_inc30r.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_pri_enc_sub.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_rf.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_wb_if.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_wb_mast.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/raw_rtl/wb_dma_wb_slv.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module wb_dma_top">>raptor_tcl.tcl 
