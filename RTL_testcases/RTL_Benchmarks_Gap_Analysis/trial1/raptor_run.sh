...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/trial1_reg_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/trial1_reg_top.sv">>raptor_tcl.tcl
    ##vary design to design
