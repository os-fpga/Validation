...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/W_int32.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/butterfly.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/cascade_0.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/cascade_n.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/delay_line.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/fft_int_size.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/round32.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/size_ctrl.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./fft_int_size/yx_addr.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module fft_int_size">>raptor_tcl.tcl 
