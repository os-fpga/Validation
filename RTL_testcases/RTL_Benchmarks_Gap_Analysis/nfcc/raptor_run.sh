...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/kasumi/keyschedule.vhdl">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/kasumi/sbox.vhdl">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/kasumi/kasumi.vhdl">>raptor_tcl.tcl
    ##vary design to design
