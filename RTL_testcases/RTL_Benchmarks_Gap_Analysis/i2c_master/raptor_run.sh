...
#creating a tcl file to run raptor flow 
    ...
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_defines.svh">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_byte_ctrl.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/StateMachine.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_bit_ctrl.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_defines.vh">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_bit_ctrl.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/StateMachine.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_byte_ctrl.v">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_byte_ctrl.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/StateMachine.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_master_bit_ctrl.sv">>raptor_tcl.tcl
