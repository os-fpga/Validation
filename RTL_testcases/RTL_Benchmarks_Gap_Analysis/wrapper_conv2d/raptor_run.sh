...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/$design.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/ksa1.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/mux.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/ksa.v">>raptor_tcl.tcl
