...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/TETRA_phy.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/diffPhaseDecoder.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/diffPhaseEncoder.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/dataConverter.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/d_encoder_d_decoder.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module d_encoder_d_decoder">>raptor_tcl.tcl 
