...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_fifo_ctrl.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_in_fifo.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_int.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_out_fifo.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_prc.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_rf.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_rst.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_sin.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_soc.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_sout.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_top.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ac97_wb_if.v">>raptor_tcl.tcl 
    
    ##vary design to design

    echo "set_top_module ac97_top">>raptor_tcl.tcl 
