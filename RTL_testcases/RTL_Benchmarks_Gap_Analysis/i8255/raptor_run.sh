...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i8255.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tsti8255.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module tsti8255">>raptor_tcl.tcl 
