...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_library_path ./wrapper_rtl/">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_ext .v .sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/conv2d.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/wrapper_conv2d.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/adder.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/fadder.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/mux.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/control.v">>raptor_tcl.tcl
    ##vary design to design
