...
sed -i "s|// 	wire \[0:0\] bcd\[0\]_gfpga;|   integer i;|" $(find . -type f -name "fabric_bin2bcd_formal_random_top_tb.v")
sed -i "s|// 	wire \[0:0\] bcd\[1\]_gfpga;|   integer mismatch=0;|" $(find . -type f -name "fabric_bin2bcd_formal_random_top_tb.v")
