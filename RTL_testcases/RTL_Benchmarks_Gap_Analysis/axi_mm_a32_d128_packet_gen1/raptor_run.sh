...
design="axi_mm_a32_d128_packet_gen1"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_master_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_master_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_master_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_slave_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_slave_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_gen1_slave_top.sv">>raptor_tcl.tcl
    ...
    echo "set_top_module axi_mm_a32_d128_packet_gen1_master_top">>raptor_tcl.tcl 
