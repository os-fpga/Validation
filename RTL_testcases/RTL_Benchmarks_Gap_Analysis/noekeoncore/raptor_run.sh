...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/gamma.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_5.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/round_f.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_2.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/pi_1.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/output_trans.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_3.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/t_m_2.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_4.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_6.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/t_m_3.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/pi_2.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/theta.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/t_m_1.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/rc_gen.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/g_m_1.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/noekeon.vhd">>raptor_tcl.tcl
    ##vary design to design
