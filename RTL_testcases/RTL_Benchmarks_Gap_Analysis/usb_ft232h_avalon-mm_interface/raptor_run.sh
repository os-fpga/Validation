...
design="usb_ft232h_avalon-mm_interface"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ft232h_fifos_interface.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ft232h_receiver.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ft232h_transmitter.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pipeline.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_ft232h.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_fifos_avalon_mm_interface.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module usb_fifos_avalon_mm_interface">>raptor_tcl.tcl 
