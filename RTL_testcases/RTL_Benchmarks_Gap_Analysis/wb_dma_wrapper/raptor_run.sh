...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_defines.vh">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_rf.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_wb_mast.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_de.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_ch_pri_enc.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_ch_arb.v">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/wb_dma_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/wrapper_rtl/$design.v">>raptor_tcl.tcl
    ##vary design to design
