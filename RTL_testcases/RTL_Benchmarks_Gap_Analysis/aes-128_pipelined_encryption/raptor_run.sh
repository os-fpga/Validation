...
design="aes-128_pipelined_encryption"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Top_PipelinedCipher.v">>raptor_tcl.tcl 
    
    ##vary design to design

    echo "set_top_module Top_PipelinedCipher">>raptor_tcl.tcl 
