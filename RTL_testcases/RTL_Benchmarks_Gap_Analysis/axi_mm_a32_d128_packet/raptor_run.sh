...
design="axi_mm_a32_d128_packet_master_top"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_master_top.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_slave_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/syncfifo_reg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_slave_name.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_master_name.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_master_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_a32_d128_packet_slave_top.sv">>raptor_tcl.tcl
