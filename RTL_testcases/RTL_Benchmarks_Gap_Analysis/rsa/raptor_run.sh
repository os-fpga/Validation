...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/modmult32.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/rsacypher.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/modmult.vhd">>raptor_tcl.tcl
    ##vary design to design
