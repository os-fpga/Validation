...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_include_path ./rtl/verilog">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_path ./rtl/verilog">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_library_ext .v .sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/verilog/wb_descontroller_top.v">>raptor_tcl.tcl
    ##vary design to design
