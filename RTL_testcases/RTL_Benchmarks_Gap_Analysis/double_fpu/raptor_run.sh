...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_double.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_exceptions.v">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_TB.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_add.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_sub.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_round.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_div.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/fpu_mul.v">>raptor_tcl.tcl
    ##vary design to design
