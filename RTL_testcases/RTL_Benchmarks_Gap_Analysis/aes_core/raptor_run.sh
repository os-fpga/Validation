...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_inv/aes_inv_cipher_top.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_inv/aes_inv_sbox.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_inv/aes_key_expand_128.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_inv/aes_rcon.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_inv/aes_sbox.v">>raptor_tcl.tcl
    
    ##vary design to design

    echo "set_top_module aes_inv_cipher_top">>raptor_tcl.tcl 
