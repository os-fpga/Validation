...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54_bshft.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54_cssu.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54_exp.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54_mac.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54_treg.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/oc54x.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module oc54_cpu">>raptor_tcl.tcl 
