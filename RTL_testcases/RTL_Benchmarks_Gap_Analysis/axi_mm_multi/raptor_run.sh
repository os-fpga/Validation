...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_master_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_master_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_master_name.sv">>raptor_tcl.tcl

    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_master_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_master_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_master_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_slave_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_slave_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier1/aximm_ll_multi_tier1_slave_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_slave_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_slave_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aximm_ll_multi_tier2/aximm_ll_multi_tier2_slave_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_slave_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_mm_master_top.sv">>raptor_tcl.tcl
    ...
    echo "set_top_module axi_mm_master_top">>raptor_tcl.tcl 
