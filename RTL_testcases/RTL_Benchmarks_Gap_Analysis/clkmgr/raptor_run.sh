...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/clkmgr_reg_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/clkmgr_pkg.sv">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/clkmgr.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/clkmgr_reg_top.sv">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_generic_clock_gating.sv">>raptor_tcl.tcl 
