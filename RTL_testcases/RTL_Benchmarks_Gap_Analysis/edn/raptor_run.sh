...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/csrng_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn_ack_sm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn_core.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn_main_sm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_alert_sender.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_arbiter_ppc.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edn.sv">>raptor_tcl.tcl
    ##vary design to design
