...
design="prim_xilinx_pad_wrapper"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/IOBUF.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/prim_xilinx_pad_wrapper.sv">>raptor_tcl.tcl
    ##vary design to design
