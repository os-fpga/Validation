...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SPW_TOP.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SpwTCR_FSM.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SpwTCR_FSM_TIMER.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SpwTCR_RX.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SpwTCR_RX_CLOCK_RECOVER.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/RTL_VA/SpwTCR_RX_FIFO.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module SPW_TOP">>raptor_tcl.tcl 
