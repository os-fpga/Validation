...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_master_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_master_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_slave_concat.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_slave_name.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_slave_top.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_lite_a32_d32_master_top.sv">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module axi_lite_a32_d32_master_top">>raptor_tcl.tcl 
