...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/glitch_filter.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_to_wb_config.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_to_wb_fsm.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_to_wb_if.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/i2c_to_wb_top.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module i2c_to_wb_top">>raptor_tcl.tcl 
