...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_core_ibex_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_core_ibex_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_dm_reg_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_timer_reg_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_timer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rv_timer_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/timer_core.sv">>raptor_tcl.tcl
