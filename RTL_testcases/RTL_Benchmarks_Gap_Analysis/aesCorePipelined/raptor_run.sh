...
design="aes_pipelined_cipher_top"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/aes_pipelined_cipher_top.v">>raptor_tcl.tcl
    
    ##vary design to design

    echo "set_top_module aes_pipelined_cipher_top">>raptor_tcl.tcl 
