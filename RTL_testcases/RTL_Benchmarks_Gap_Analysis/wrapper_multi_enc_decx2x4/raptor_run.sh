...
design="wrapper_multi_enc_decx2x4"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/decoder.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/$design.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/multi_enc_decx2x4.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/topenc_decx2.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./wrapper_rtl/encoder.v">>raptor_tcl.tcl
    ##vary design to design
