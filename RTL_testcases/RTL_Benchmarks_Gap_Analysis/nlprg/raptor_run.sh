...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/dff.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/nlprg8.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module nlprg8">>raptor_tcl.tcl 
