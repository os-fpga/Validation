...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ariane_axi_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_adapter.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_intf.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/axi_shim.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/registers.svh">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cvxif_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cvxif_instr_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cvxif_example_coprocessor.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cvxif_fu.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ariane.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/SyncSpRamBeNx64.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/alu.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/amo_alu.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/amo_buffer.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ariane_regfile_ff.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ariane_rvfi_pkg.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/bht.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/branch_unit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/btb.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/std_cache_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cache_ctrl.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/cf_math_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/commit_stage.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/compressed_decoder.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/defs_div_sqrt_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/control_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/controller.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/counter.sv">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/delta_counter.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/div_sqrt_top_mvp.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/dromajo_ram.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ex_stage.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/exp_backoff.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fifo_v3.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_pkg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_cast_multi.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_classifier.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_divsqrt_multi.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_fma.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_fma_multi.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_noncomp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_opgroup_block.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_opgroup_fmt_slice.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_opgroup_multifmt_slice.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_rounding.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpnew_top.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpu_wrap.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/frontend.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/id_stage.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/instr_decoder.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/instr_queue.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/instr_realign.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/instr_scan.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/issue_read_operands.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/issue_stage.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/iteration_div_sqrt_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/lfsr.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/lfsr_8bit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/load_store_unit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/load_unit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/lzc.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/miss_handler.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mmu.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mult.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/multiplier.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/norm_div_sqrt_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/nrbd_nrsc_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/perf_counters.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pmp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pmp_entry.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/popcount.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/preprocess_mvp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ptw.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ras.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/re_name.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rr_arb_tree.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/scoreboard.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/serdiv.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/shift_reg.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sram.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/std_cache_subsystem.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/std_nbdcache.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/store_buffer.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/store_unit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/stream_arbiter.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/stream_arbiter_flushable.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/stream_demux.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/stream_mux.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tag_cmp.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tlb.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/unread.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_axi_adapter.sv">>raptor_tcl.tcl  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_cache_subsystem.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_dcache.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_dcache_ctrl.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_dcache_mem.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_dcache_missunit.sv">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wt_dcache_wbuffer.sv">>raptor_tcl.tcl 

    ##vary design to design

    echo "set_top_module ariane">>raptor_tcl.tcl 
