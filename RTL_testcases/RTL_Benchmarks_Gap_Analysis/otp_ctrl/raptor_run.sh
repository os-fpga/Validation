...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_otp_pkg.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_part_pkg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_core_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_dai.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_ecc_reg.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_kdi.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_lci.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_lfsr_timer.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_part_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_part_unbuf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/otp_ctrl_scrmbl.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_double_lfsr.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_generic_otp.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_intr_hw.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_lc_sender.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_mubi8_sender.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_otp.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_packer_fifo.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_present.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_ram_1p_scr.sv">>raptor_tcl.tcl
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_reg_cdc.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_sec_anchor_buf.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_sec_anchor_flop.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_secded_inv_72_64_dec.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/prim_secded_inv_72_64_enc.sv">>raptor_tcl.tcl
