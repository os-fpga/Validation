...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/biquad.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/bqmain.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/coefio.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/multa.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/multb.v">>raptor_tcl.tcl 
    
    ##vary design to design

    echo "set_top_module bqmain">>raptor_tcl.tcl 
