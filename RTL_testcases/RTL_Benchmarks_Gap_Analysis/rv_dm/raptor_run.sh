...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/dm_csrs.sv">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rv_dm.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rv_dm_regs_reg_top.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rv_dm_rom_reg_top.sv">>raptor_tcl.tcl
    ...
    echo "set_top_module rv_dm_rom_reg_top">>raptor_tcl.tcl 
