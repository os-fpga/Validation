...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pwm_reader.v">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/serial_divide_uu.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module pwm_reader">>raptor_tcl.tcl 
