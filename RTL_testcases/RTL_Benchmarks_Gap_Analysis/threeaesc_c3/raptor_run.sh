...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/aes_c_3/src/aes_lib.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/aes_c_3/src/dual_mem.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/aes_c_3/src/aes_enc.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/aes_c_3/src/aes_fsm_enc.vhd">>raptor_tcl.tcl
    ##vary design to design
