...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/BM_lamda.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/DP_RAM.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/GF_matrix_ascending_binary.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/GF_matrix_dec.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/GF_mult_add_syndromes.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Omega_Phy.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/error_correction.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/input_syndromes.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/lamda_roots.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/out_stage.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rs_decoder_top.v">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/transport_in2out.v">>raptor_tcl.tcl 
    
    ##vary design to design

    echo "set_top_module RS_dec_top">>raptor_tcl.tcl 
