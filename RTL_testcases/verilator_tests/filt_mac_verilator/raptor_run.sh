...
#creating a tcl file to run raptor flow 
    ...
    echo "add_simulation_file ./sim/co_sim_tb/tb_$design.cpp ./sim/co_sim_tb/co_sim_$design.sv" >> raptor_tcl.tcl
    ...
    echo "simulation_options verilator compilation rtl --timing -sc -DUSE_FILE_A ">>raptor_tcl.tcl
