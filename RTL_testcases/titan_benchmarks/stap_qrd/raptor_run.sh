...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qrd192x204_DUT.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qrd192x204_DUT_Processor.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/qrd192x204_safe_path.vhd">>raptor_tcl.tcl || echo "" 
    ...
    echo "set_top_module qrd192x204_DUT">>raptor_tcl.tcl 
