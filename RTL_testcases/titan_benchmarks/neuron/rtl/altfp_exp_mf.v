...
module  altfp_exp_mf_altfp_exp_5cg
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		zero_wi = zero_w,
		zero_wo = zero_dffe16;
endmodule //altfp_exp_mf_altfp_exp_5cg
//VALID FILE
...
module altfp_exp_mf (
  ...
  wire        resulten = data_en_d[16];
	...
	altfp_exp_mf_altfp_exp_5cg	altfp_exp_mf_altfp_exp_5cg_component (
				.clk_en (clk_en),
				.clock (clock),
				.aclr (aclr),
				.data (data),
