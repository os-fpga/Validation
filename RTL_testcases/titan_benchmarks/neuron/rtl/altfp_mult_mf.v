...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix IV" EXCEPTION_HANDLING="NO" PIPELINE=11 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab nan overflow result underflow zero
//VERSION_BEGIN 11.1 cbx_alt_ded_mult_y 2011:10:31:21:11:05:SJ cbx_altbarrel_shift 2011:10:31:21:11:05:SJ cbx_altera_mult_add 2011:10:31:21:11:05:SJ cbx_altfp_mult 2011:10:31:21:11:05:SJ cbx_altmult_add 2011:10:31:21:11:05:SJ cbx_cycloneii 2011:10:31:21:11:05:SJ cbx_lpm_add_sub 2011:10:31:21:11:05:SJ cbx_lpm_compare 2011:10:31:21:11:05:SJ cbx_lpm_mult 2011:10:31:21:11:05:SJ cbx_mgl 2011:10:31:21:12:31:SJ cbx_padd 2011:10:31:21:11:05:SJ cbx_parallel_add 2011:10:31:21:11:05:SJ cbx_stratix 2011:10:31:21:11:05:SJ cbx_stratixii 2011:10:31:21:11:05:SJ cbx_util_mgl 2011:10:31:21:11:05:SJ  VERSION_END
...
module  altfp_mult_mf_altfp_mult_sir
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		zero = zero_ff;
endmodule //altfp_mult_mf_altfp_mult_sir
//VALID FILE
...
module altfp_mult_mf (
  ...
  input         dataen;
	...
	wire  zero = sub_wire1;
	wire  nan = sub_wire2;
  reg [31:0] result_d [5:0];
  reg [16:0] data_en_d;
	//wire [31:0] result = sub_wire3[31:0];
	wire [31:0] result = result_d[5];
  wire        resulten = data_en_d[16];
	wire  underflow = sub_wire4;

	altfp_mult_mf_altfp_mult_sir	altfp_mult_mf_altfp_mult_sir_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
  ...
  // multiplier output latency is 11-clock cycles
  integer i;
