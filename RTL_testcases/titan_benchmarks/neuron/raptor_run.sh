...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_add_sub_mf.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_add_sub_mf_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_add_sub_mf_inst.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_conv_mf.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_conv_mf_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_conv_mf_inst.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_div_mf.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_div_mf_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_div_mf_inst.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_exp_mf.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_exp_mf_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_exp_mf_inst.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_mult_mf.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_mult_mf_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/altfp_mult_mf_inst.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_core.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system_input_data.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system_output_data.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system_timing_adapter.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system_timing_adapter_1.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hh_system_timing_adapter_1_fifo.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/hodgkin_huxley.v">>raptor_tcl.tcl || echo "" 
    ...
    echo "set_top_module hh_system">>raptor_tcl.tcl 
