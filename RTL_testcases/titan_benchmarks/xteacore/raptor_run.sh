...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/key_schedule.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/round_f.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/xtea.vhd">>raptor_tcl.tcl || echo ""
    ##vary design to design
