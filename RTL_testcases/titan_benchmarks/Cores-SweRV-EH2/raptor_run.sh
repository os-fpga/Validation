...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_pkg.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/beh_lib.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/dmi_jtag_to_core_sync.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/dmi_wrapper.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dbg.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_csr.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_decode_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_gpr_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_ib_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_tlu_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_tlu_top.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dec_trigger.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_def.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_dma_ctrl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_exu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_exu_alu_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_exu_div_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_exu_mul_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_aln_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_bp_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_btb_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_compress_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_ic_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_iccm_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_ifc_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_mem_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_ifu_tb_memread.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lib.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_addrcheck.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_amo.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_bus_buffer.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_bus_intf.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_clkdomain.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_dccm_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_dccm_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_ecc.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_lsc_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_stbuf.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_lsu_trigger.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_pic_ctrl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_swerv.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/eh2_swerv_wrapper.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/rvjtag_tap.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ahb_to_axi4.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/axi4_to_ahb.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/mem_lib.sv">>raptor_tcl.tcl || echo ""
    ##vary design to design
