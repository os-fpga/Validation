...
// 
// Generated using ACDS version 11.1sp2 259 at 2012.03.07.21:59:01
...
module ddr_dmaster #(
	...
	ddr_dmaster_timing_adt timing_adt (
		.clk       (clk_clk),                                    //   clk.clk
	...
	ddr_dmaster_b2p_adapter b2p_adapter (
		.clk               (clk_clk),                              //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),      // reset.reset_n
	...
	ddr_dmaster_p2b_adapter p2b_adapter (
		.clk               (clk_clk),                            //   clk.clk
		.reset_n           (~rst_controller_reset_out_reset),    // reset.reset_n
