...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_a0.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_a1.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_b0.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_b1.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_c0.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_c1.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_d0.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_d1.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_grp_fu_220_ACMP_faddfsub_30.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_grp_fu_226_ACMP_fmul_31.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_grp_fu_235_ACMP_fdiv_32.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_grp_fu_241_ACMP_fdiv_33.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Gaussianblur_grp_fu_245_ACMP_fsqrt_34.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fetch.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step0.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step0_grp_fu_2163_ACMP_fadd_5.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step0_grp_fu_2167_ACMP_fmul_6.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step1.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step1_grp_fu_811_ACMP_fadd_13.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step1_grp_fu_815_ACMP_fmul_14.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/step1_grp_fu_819_ACMP_fmul_15.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/write_r.v">>raptor_tcl.tcl || echo ""
    ##vary design to design

    echo "set_top_module Gaussianblur">>raptor_tcl.tcl 
