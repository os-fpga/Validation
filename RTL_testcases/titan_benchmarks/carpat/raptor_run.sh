...
design="ray_tracer_triangle_framework"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/model_vhd.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/$design.v">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module carpat">>raptor_tcl.tcl 
