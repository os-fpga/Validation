...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/vhdl_altera_de1/de1.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/vhdl_altera_de1/index_table.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/vhdl_altera_de1/pll.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/vhdl_altera_de1/spi_slave.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/vhdl_altera_de1/curl.vhd">>raptor_tcl.tcl || echo ""
    ##vary design to design
