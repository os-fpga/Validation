...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/DataTransferUnit.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/LU.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/LU230PEEng.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/LUControl.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/MarshallerController.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/addr_fifo.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/alt_mem_phy_defines.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/alt_mem_phy_sequencer.vhd">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/auk_ddr_hp_controller.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_auk_ddr_hp_controller_wrapper.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_controller_phy.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_ex_lfsr8.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_example_driver.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_example_top.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy_alt_mem_phy_pll_siii.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy_alt_mem_phy_pll_siii_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy_alt_mem_phy_sequencer_wrapper.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy_alt_mem_phy_siii.v">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_design_file ./rtl/ddr2_24x64_8_phy_bb.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/divsp.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/memcmd_fifo.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mult_add.v">>raptor_tcl.tcl || echo "" 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/rfifo.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/subsplat14.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/top_ram.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wfifo.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module LU230PEEng">>raptor_tcl.tcl 
