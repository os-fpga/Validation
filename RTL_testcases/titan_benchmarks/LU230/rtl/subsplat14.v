...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix III" DIRECTION="SUB" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab result
//VERSION_BEGIN 8.0 cbx_altbarrel_shift 2008:02:23:252825 cbx_altfp_add_sub 2008:02:23:252825 cbx_altpriority_encoder 2008:02:23:252825 cbx_cycloneii 2008:02:23:252825 cbx_lpm_add_sub 2008:03:09:257947 cbx_lpm_compare 2008:02:23:252825 cbx_mgl 2008:04:11:273944 cbx_stratix 2008:02:23:252825 cbx_stratixii 2008:02:23:252825  VERSION_END
...
//VERSION_BEGIN 8.0 cbx_altbarrel_shift 2008:02:23:252825 cbx_mgl 2008:04:11:273944  VERSION_END

//synthesis_resources = reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altbarrel_shift_s4e
	( 
	aclr,
	clk_en,
	clock,
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) pipe_wl1c <= 26'b0;
		else if  (clk_en == 1'b1)   pipe_wl1c <= ((({26{(sel_w[4] & (~ direction_w))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & direction_w)}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104]));
	assign
		direction_w = 1'b0,
		pad_w = 16'b0000000000000000,
		result = sbit_w[155:130],
		sbit_w = {pipe_wl1c, ((({26{(sel_w[3] & (~ direction_w))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & direction_w)}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ direction_w))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & direction_w)}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ direction_w))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & direction_w)}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ direction_w))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & direction_w)}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0])), data},
		sel_w = {distance[4:0]};
endmodule //subsplat14_altbarrel_shift_s4e


//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix III" PIPELINE=2 REGISTER_OUTPUT="NO" SHIFTDIR="RIGHT" WIDTH=26 WIDTHDIST=5 aclr clk_en clock data distance result
//VERSION_BEGIN 8.0 cbx_altbarrel_shift 2008:02:23:252825 cbx_mgl 2008:04:11:273944  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altbarrel_shift_38g
	( 
	aclr,
	clk_en,
	clock,
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) pipe_wl1c <= 26'b0;
		else if  (clk_en == 1'b1)   pipe_wl1c <= ((({26{(sel_w[1] & (~ direction_w))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & direction_w)}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26]));
	// synopsys translate_off
	initial
		pipe_wl2c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) pipe_wl2c <= 26'b0;
		else if  (clk_en == 1'b1)   pipe_wl2c <= ((({26{(sel_w[3] & (~ direction_w))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & direction_w)}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78]));
	// synopsys translate_off
	initial
		sel_pipel2d1c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sel_pipel2d1c <= 1'b0;
		else if  (clk_en == 1'b1)   sel_pipel2d1c <= distance[2];
	// synopsys translate_off
	initial
		sel_pipel3d1c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sel_pipel4d2c <= 1'b0;
		else if  (clk_en == 1'b1)   sel_pipel4d2c <= sel_pipel4d1c;
	assign
		direction_w = 1'b1,
		pad_w = 16'b0000000000000000,
		result = sbit_w[155:130],
		sbit_w = {((({26{(sel_w[4] & (~ direction_w))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & direction_w)}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), pipe_wl2c, ((({26{(sel_w[2] & (~ direction_w))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & direction_w)}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), pipe_wl1c, ((({26{(sel_w[0] & (~ direction_w))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & direction_w)}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0])), data},
		sel_w = {sel_pipel4d2c, sel_pipel3d1c, sel_pipel2d1c, distance[1:0]};
endmodule //subsplat14_altbarrel_shift_38g


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" LSB_PRIORITY="YES" PIPELINE=2 WIDTH=32 WIDTHAD=5 aclr clk_en clock data q
//VERSION_BEGIN 8.0 cbx_altpriority_encoder 2008:02:23:252825 cbx_mgl 2008:04:11:273944  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_nh8
	( 
	data,
	q,
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //subsplat14_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	subsplat14_altpriority_encoder_nh8   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	subsplat14_altpriority_encoder_nh8   altpriority_encoder19
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	assign
		q = {wire_altpriority_encoder18_zero, ((wire_altpriority_encoder18_zero & wire_altpriority_encoder19_q) | ((~ wire_altpriority_encoder18_zero) & wire_altpriority_encoder18_q))},
		zero = (wire_altpriority_encoder18_zero & wire_altpriority_encoder19_zero);
endmodule //subsplat14_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_2h9
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	subsplat14_altpriority_encoder_qh8   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	subsplat14_altpriority_encoder_qh8   altpriority_encoder17
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder17_q),
	.zero(wire_altpriority_encoder17_zero));
	assign
		q = {wire_altpriority_encoder16_zero, (({2{wire_altpriority_encoder16_zero}} & wire_altpriority_encoder17_q) | ({2{(~ wire_altpriority_encoder16_zero)}} & wire_altpriority_encoder16_q))},
		zero = (wire_altpriority_encoder16_zero & wire_altpriority_encoder17_zero);
endmodule //subsplat14_altpriority_encoder_2h9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_d6b
	( 
	aclr,
	clk_en,
	clock,
	...
	subsplat14_altpriority_encoder_2h9   altpriority_encoder14
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	subsplat14_altpriority_encoder_2h9   altpriority_encoder15
	( 
	.data(data[15:8]),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder14_zero, (({3{wire_altpriority_encoder14_zero}} & wire_altpriority_encoder15_q) | ({3{(~ wire_altpriority_encoder14_zero)}} & wire_altpriority_encoder14_q))},
		tmp_zero_wire = (wire_altpriority_encoder14_zero & wire_altpriority_encoder15_zero),
		zero = (~ pipeline_zero_n_dffe);
endmodule //subsplat14_altpriority_encoder_d6b
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_n28
	( 
	data,
	...
	assign
		q = {(~ data[0])};
endmodule //subsplat14_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_q28
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	wire  [0:0]   wire_altpriority_encoder24_q;
	wire  wire_altpriority_encoder24_zero;
	wire  [0:0]   wire_altpriority_encoder25_q;

	subsplat14_altpriority_encoder_nh8   altpriority_encoder24
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	subsplat14_altpriority_encoder_n28   altpriority_encoder25
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder25_q));
	assign
		q = {wire_altpriority_encoder24_zero, ((wire_altpriority_encoder24_zero & wire_altpriority_encoder25_q) | ((~ wire_altpriority_encoder24_zero) & wire_altpriority_encoder24_q))};
endmodule //subsplat14_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_229
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	subsplat14_altpriority_encoder_qh8   altpriority_encoder22
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	subsplat14_altpriority_encoder_q28   altpriority_encoder23
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder23_q));
	assign
		q = {wire_altpriority_encoder22_zero, (({2{wire_altpriority_encoder22_zero}} & wire_altpriority_encoder23_q) | ({2{(~ wire_altpriority_encoder22_zero)}} & wire_altpriority_encoder22_q))};
endmodule //subsplat14_altpriority_encoder_229

//synthesis_resources = reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_ena
	( 
	aclr,
	clk_en,
	clock,
	...
	subsplat14_altpriority_encoder_2h9   altpriority_encoder20
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	subsplat14_altpriority_encoder_229   altpriority_encoder21
	( 
	.data(data[15:8]),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder20_zero, (({3{wire_altpriority_encoder20_zero}} & wire_altpriority_encoder21_q) | ({3{(~ wire_altpriority_encoder20_zero)}} & wire_altpriority_encoder20_q))};
endmodule //subsplat14_altpriority_encoder_ena

//synthesis_resources = reg 14 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_dna
	( 
	aclr,
	clk_en,
	clock,
	...
	subsplat14_altpriority_encoder_d6b   altpriority_encoder12
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	subsplat14_altpriority_encoder_ena   altpriority_encoder13
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		q = (~ pipeline_q_dffe),
		tmp_q_wire = {wire_altpriority_encoder12_zero, (({4{wire_altpriority_encoder12_zero}} & wire_altpriority_encoder13_q) | ({4{(~ wire_altpriority_encoder12_zero)}} & wire_altpriority_encoder12_q))};
endmodule //subsplat14_altpriority_encoder_dna
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_3v7
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //subsplat14_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //subsplat14_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_6v7
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	wire  [0:0]   wire_altpriority_encoder32_q;
	wire  [0:0]   wire_altpriority_encoder33_q;
	wire  wire_altpriority_encoder33_zero;

	subsplat14_altpriority_encoder_3v7   altpriority_encoder32
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder32_q));
	subsplat14_altpriority_encoder_3e8   altpriority_encoder33
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	assign
		q = {(~ wire_altpriority_encoder33_zero), ((wire_altpriority_encoder33_zero & wire_altpriority_encoder32_q) | ((~ wire_altpriority_encoder33_zero) & wire_altpriority_encoder33_q))};
endmodule //subsplat14_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	wire  [0:0]   wire_altpriority_encoder35_q;
	wire  wire_altpriority_encoder35_zero;

	subsplat14_altpriority_encoder_3e8   altpriority_encoder34
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	subsplat14_altpriority_encoder_3e8   altpriority_encoder35
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder35_q),
	.zero(wire_altpriority_encoder35_zero));
	assign
		q = {(~ wire_altpriority_encoder35_zero), ((wire_altpriority_encoder35_zero & wire_altpriority_encoder34_q) | ((~ wire_altpriority_encoder35_zero) & wire_altpriority_encoder35_q))},
		zero = (wire_altpriority_encoder34_zero & wire_altpriority_encoder35_zero);
endmodule //subsplat14_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_bv7
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	wire  [1:0]   wire_altpriority_encoder30_q;
	wire  [1:0]   wire_altpriority_encoder31_q;
	wire  wire_altpriority_encoder31_zero;

	subsplat14_altpriority_encoder_6v7   altpriority_encoder30
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder30_q));
	subsplat14_altpriority_encoder_6e8   altpriority_encoder31
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	assign
		q = {(~ wire_altpriority_encoder31_zero), (({2{wire_altpriority_encoder31_zero}} & wire_altpriority_encoder30_q) | ({2{(~ wire_altpriority_encoder31_zero)}} & wire_altpriority_encoder31_q))};
endmodule //subsplat14_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_be8
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	wire  [1:0]   wire_altpriority_encoder36_q;
	wire  wire_altpriority_encoder36_zero;
	wire  [1:0]   wire_altpriority_encoder37_q;
	wire  wire_altpriority_encoder37_zero;

	subsplat14_altpriority_encoder_6e8   altpriority_encoder36
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	subsplat14_altpriority_encoder_6e8   altpriority_encoder37
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder37_q),
	.zero(wire_altpriority_encoder37_zero));
	assign
		q = {(~ wire_altpriority_encoder37_zero), (({2{wire_altpriority_encoder37_zero}} & wire_altpriority_encoder36_q) | ({2{(~ wire_altpriority_encoder37_zero)}} & wire_altpriority_encoder37_q))},
		zero = (wire_altpriority_encoder36_zero & wire_altpriority_encoder37_zero);
endmodule //subsplat14_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_uv8
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	wire  [2:0]   wire_altpriority_encoder28_q;
	wire  [2:0]   wire_altpriority_encoder29_q;
	wire  wire_altpriority_encoder29_zero;

	subsplat14_altpriority_encoder_bv7   altpriority_encoder28
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder28_q));
	subsplat14_altpriority_encoder_be8   altpriority_encoder29
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	assign
		q = {(~ wire_altpriority_encoder29_zero), (({3{wire_altpriority_encoder29_zero}} & wire_altpriority_encoder28_q) | ({3{(~ wire_altpriority_encoder29_zero)}} & wire_altpriority_encoder29_q))};
endmodule //subsplat14_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	wire  [2:0]   wire_altpriority_encoder39_q;
	wire  wire_altpriority_encoder39_zero;

	subsplat14_altpriority_encoder_be8   altpriority_encoder38
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder38_q),
	.zero(wire_altpriority_encoder38_zero));
	subsplat14_altpriority_encoder_be8   altpriority_encoder39
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder39_q),
	.zero(wire_altpriority_encoder39_zero));
	assign
		q = {(~ wire_altpriority_encoder39_zero), (({3{wire_altpriority_encoder39_zero}} & wire_altpriority_encoder38_q) | ({3{(~ wire_altpriority_encoder39_zero)}} & wire_altpriority_encoder39_q))},
		zero = (wire_altpriority_encoder38_zero & wire_altpriority_encoder39_zero);
endmodule //subsplat14_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
	...
	subsplat14_altpriority_encoder_uv8   altpriority_encoder26
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder26_q));
	subsplat14_altpriority_encoder_ue9   altpriority_encoder27
	( 
	.data(data[31:16]),
	...
	assign
		q = pipeline_q_dffe,
		tmp_q_wire = {(~ wire_altpriority_encoder27_zero), (({4{wire_altpriority_encoder27_zero}} & wire_altpriority_encoder26_q) | ({4{(~ wire_altpriority_encoder27_zero)}} & wire_altpriority_encoder27_q))};
endmodule //subsplat14_altpriority_encoder_ou8

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 813 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  subsplat14_altfp_add_sub_d7j
	( 
	clock,
	dataa,
	datab,
	...
	wire  [25:0]   wire_altbarrel_shift10_result;
	wire  [25:0]   wire_altbarrel_shift3_result;
	wire  [4:0]   wire_altpriority_encoder4_q;
	...
	wire  [8:0]   wire_add_sub11_result;
	wire  [8:0]   wire_add_sub2_result;
	wire  [5:0]   wire_add_sub5_result;
	wire  [8:0]   wire_add_sub8_result;
	...
	subsplat14_altbarrel_shift_s4e   altbarrel_shift10
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	.result(wire_altbarrel_shift10_result));
	subsplat14_altbarrel_shift_38g   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	subsplat14_altpriority_encoder_dna   altpriority_encoder4
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	.data({10'b0000000000, man_smaller_dffe13_wo[21:0]}),
	.q(wire_altpriority_encoder4_q));
	subsplat14_altpriority_encoder_ou8   altpriority_encoder7
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, 6'b000000}),
	...
	defparam
		...
		add_sub11.lpm_representation = "SIGNED",
		add_sub11.lpm_width = 9,
	...
	defparam
		cmpr6.lpm_representation = "SIGNED",
		cmpr6.lpm_width = 6,
	...
	assign
		...
		aligned_dataa_man_w = {(((~ input_dataa_infinite_dffe11_wo) & (~ input_dataa_denormal_dffe11_wo)) & (~ input_dataa_zero_dffe11_wo)), ({23{(~ input_dataa_denormal_dffe11_wo)}} & dataa_dffe11_wo[22:0]), 2'b00},
		...
		aligned_datab_man_w = {(((~ input_datab_infinite_dffe11_wo) & (~ input_datab_denormal_dffe11_wo)) & (~ input_datab_zero_dffe11_wo)), ({23{(~ input_datab_denormal_dffe11_wo)}} & datab_dffe11_wo[22:0]), 2'b00},
		...
		dataa_man_dffe1_wi = (({26{(~ exp_amb_mux_dffe15_wo)}} & aligned_dataa_man_dffe15_w) | ({26{exp_amb_mux_dffe15_wo}} & wire_altbarrel_shift3_result)),
		...
		datab_man_dffe1_wi = (({26{(~ exp_amb_mux_dffe15_wo)}} & wire_altbarrel_shift3_result) | ({26{exp_amb_mux_dffe15_wo}} & aligned_datab_man_dffe15_w)),
		...
		exp_adjustment2_add_sub_w = wire_add_sub9_result,
		exp_adjustment_add_sub_dataa_w = {priority_encoder_1pads_w, wire_altpriority_encoder7_q},
		exp_adjustment_add_sub_datab_w = {exp_adj_0pads, exp_adj_dffe26_wo},
		exp_adjustment_add_sub_w = wire_add_sub8_result,
		exp_all_ones_w = 8'b11111111,
		exp_all_zeros_w = 8'b00000000,
		...
		exp_res_rounding_adder_w = wire_add_sub11_result,
		...
		exp_rounding_adjustment_w = {8'b00000000, man_res_rounding_add_sub_w[24]},
		...
		man_all_zeros_w = 23'b00000000000000000000000,
		...
		man_leading_zeros_dffe31_wi = (~ wire_altpriority_encoder7_q),
		...
		man_res_rounding_add_sub_datab_w = {25'b0000000000000000000000000, man_rounding_add_value_w},
		man_res_rounding_add_sub_w = man_res_rounding_add_sub_result_reg,
		man_res_w3 = wire_altbarrel_shift10_result[25:2],
		...
		pos_sign_bit_ext = 2'b00,
		priority_encoder_1pads_w = 4'b1111,
		...
		sticky_bit_cnt_datab_w = {1'b0, wire_altpriority_encoder4_q},
		sticky_bit_cnt_res_w = wire_add_sub5_result,
		sticky_bit_dffe1_wi = wire_cmpr6_agb,
...
endmodule //subsplat14_altfp_add_sub_d7j
//VALID FILE
...
module subsplat14 (
	...
	subsplat14_altfp_add_sub_d7j	subsplat14_altfp_add_sub_d7j_component (
				.dataa (dataa),
				.datab (datab),
				.clock (clock),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14.inc FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14.cmp FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14_inst.v FALSE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL subsplat14_bb.v TRUE FALSE
