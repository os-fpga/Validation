...
// ============================================================
// Megafunction Name(s):
// 			ddr2_24x64_8_phy_alt_mem_phy_siii
// ============================================================
...
module ddr2_24x64_8_phy (
	...
	ddr2_24x64_8_phy_alt_mem_phy_siii	ddr2_24x64_8_phy_alt_mem_phy_siii_inst(
	...
	defparam
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ADDR_CMD_2T_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ADDR_CMD_ADD_1T = "FALSE",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ADDR_CMD_NEGEDGE_EN = "FALSE",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ADDR_COUNT_WIDTH = 4,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.CAPTURE_MIMIC_PATH = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.CLOCK_INDEX_WIDTH = 4,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DDR_MIMIC_PATH_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DEDICATED_MEMORY_CLK_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DQS_OUT_MODE = "DELAY_CHAIN3",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DQS_PHASE_SETTING = 3,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DQS_PHASE = 9000,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.DWIDTH_RATIO = 2,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.FAMILY = "Stratix III",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_TCL = "4.0",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.GENERATE_WRITE_DQS = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_CLK_PS = 3749,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_AWIDTH = 24,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_BURST_LENGTH = 2,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_BURST_LEN_BITS = 2,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_DWIDTH = 128,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_DRATE = "FULL",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.LOCAL_IF_TYPE_AVALON_STR = "false",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_ADDR_CMD_BUS_COUNT = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_MEMTYPE = "DDR2",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DWIDTH = 64,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_BE_WIDTH = 16,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DQS_WIDTH = 8,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_ROWADDR_WIDTH = 13,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_CS_WIDTH = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DM_WIDTH = 8,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DM_PINS_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DQSN_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_OCT_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_DQS_CAPTURE_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_POSTAMBLE_EN_WIDTH = 8,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_CLK_PS = 3749,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MIMIC_DEBUG_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MIMIC_PATH_TRACKING_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.NUM_MIMIC_SAMPLE_CYCLES = 6,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.NUM_DEBUG_SAMPLES_TO_STORE = 4096,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ODT_ADD_1T = "FALSE",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.PLL_EXPORT_IMPORT = "NONE",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.MEM_IF_CLK_PS_STR = "3749 ps",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.PLL_REF_CLK_PS = 10000,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.PLL_STEPS_PER_CYCLE = 32,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.PLL_TYPE = "ENHANCED",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.POSTAMBLE_INITIAL_LAT = 13,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.POSTAMBLE_AWIDTH = 6,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.POSTAMBLE_CALIBRATION_AND_SETUP_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.POSTAMBLE_HALFT_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.POSTAMBLE_RESYNC_LAT_CTL_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.RDP_INITIAL_LAT = 6,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.RDP_RESYNC_LAT_CTL_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.RESYNC_CALIBRATION_AND_SETUP_EN = 1,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.RESYNC_CALIBRATE_ONLY_ONE_BIT_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.RESYNC_PIPELINE_DEPTH = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.READ_LAT_WIDTH = 6,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.TRAINING_DATA_WIDTH = 32,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.SCAN_CLK_DIVIDE_BY = 5,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.USE_MEM_CLK_FOR_ADDR_CMD_CLK = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.ADDR_CMD_ADD_INTERMEDIATE_REGS = "FALSE",
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.QDRII_MEM_DLL_NUM_CLK_CYCLES = 2048,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.PLL_RECONFIG_PORTS_EN = 0,
		ddr2_24x64_8_phy_alt_mem_phy_siii_inst.REG_DIMM = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="ddr2_24x64_8_phy_alt_mem_phy_siii" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="ddr2_24x64_8_phy_alt_mem_phy_sequencer_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_24x64_8_phy_alt_mem_phy_sequencer_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Stratix III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+ddr2_24x64_8_phy_alt_mem_phy_delay;+ddr2_24x64_8_phy_alt_mem_phy_sequencer_wrapper;+ddr2_24x64_8_phy_alt_mem_phy_reconfig_siii;+ddr2_24x64_8_phy_alt_mem_phy_pll_siii --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/autofs/jayar/b/b5/weizer/research/project/alpharelease/CoreLib/ddr2_24x64_8/ddr2_24x64_8_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="ddr2_24x64_8_phy_gb.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
