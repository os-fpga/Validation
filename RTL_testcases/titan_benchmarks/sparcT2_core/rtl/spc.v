...
input 	     tcu_aclk_;		// PINDEF:BOT    
input 	     tcu_bclk_;		// PINDEF:BOT    
input 	     tcu_dectest;	// PINDEF:BOT    
input 	     tcu_muxtest;	// PINDEF:BOT    
input 	     tcu_scan_en_;	// PINDEF:BOT    
...
input		tcu_shscan_aclk_;	// PINDEF:BOT
input		tcu_shscan_bclk_;	// PINDEF:BOT
input		tcu_shscan_scan_in;	// PINDEF:BOT
input		tcu_shscan_scan_en_;	// PINDEF:BOT
