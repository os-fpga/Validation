...
always @(posedge l1clk_fuse) begin
	...
	for (n = 0;  n < 144; n = n + 1 ) begin
		...
		if (reg_en_lft[1] & reg_en_lft[0] & ( reg_d_lft >= 5'b00000) & (reg_d_lft <= 5'b10000)) begin
			if ( n_reg2[9:0] <  ((reg_d_lft + 5'h1) * 5'b01000 ))
				wr_data[n] = (n < 136) ? din[n] : 1'b0;
			else begin
				if ( n_reg2[9:0] <  ((reg_d_lft + 5'h2)  * 5'b01000 ))
					wr_data[n] = 1'bx ; 
				else
					wr_data[n] = (n>=8) ? din[n-8] : 1'b0;
			end
		end else begin
			if (n < 8 ) 
				wr_data[n] = 1'bx ;
...
always @ (negedge l1clk) begin//(l1clk or wr_data[143:0] or wr_word_en_ac_l[1:0] or adr_ac_h[5:0] or quaden_f_l or vnw_ary) begin
    if ( ~quaden_f_l & (~wr_word_en_ac_l[1] | ~wr_word_en_ac_l[0]) & vnw_ary) begin
 ...
 always @(negedge l1clk) begin//(l1clk or rd_en_a_l or reg_en_lft[1:0] or  reg_d_lft or adr_ac_h[5:0] or rd_worden_ac_l[0] or vnw_ary) begin
...
module n2_icd_lft_sb_array(adr_ac_h, adr_ac_l, rd_en_a_l, quaden_f_l, 
	...
	assign data_in[135:0] = {din0_a[16], din1_a[16], din0_a[16], din1_a[16],
		...
		din0_a[0], din1_a[0]};
	assign din[135:0] = data_in[135:0]; /* (((way_write_en[135:0] & word_write_en[135:0]) & 
	...
	always @(negedge l1clk) begin
		for (n = 0; n < 136; n = n+1) begin
			if (((~quaden_f_l) & ((~wr_word_en_ac_l[1]) | (~
				wr_word_en_ac_l[0]))) & vnw_ary & way_write_en[n] & word_write_en[n]) begin
					mem[adr_ac_h[5:0]][n] <= wr_data[n];
			end
	  end
	...
	always @(local_dout or word_0_read) begin
	    dout = local_dout;
	    way3_word0[16:0] = {dout[135], dout[127], dout[119], dout[111], 
...
always @ (negedge l1clk) begin//(l1clk or wr_data[135:0] or wr_word_en_ac_l[1:0] or adr_ac_h[5:0] or quaden_f_l or vnw_ary) begin
    if ( ~quaden_f_l & (~wr_word_en_ac_l[1] | ~wr_word_en_ac_l[0]) & vnw_ary) begin
 ...
 always @(negedge l1clk) begin//(l1clk or rd_en_a_l or reg_en_rgt[1:0] or  reg_d_rgt or adr_ac_h[5:0] or rd_worden_ac_l[0] or vnw_ary) begin
    /*if (l1clk | rd_en_a_l) begin
...
module n2_icd_rgt_sb_array(adr_ac_h, adr_ac_l, rd_en_a_l, quaden_f_l, 
	...
	assign din[127:0] = data_in[127:0]; /*(((way_write_en[127:0] & word_write_en[127:0]) & 
	...
	always @(negedge l1clk) begin
	  for (n = 0; n < 128; n = n + 1) begin
	  if ((((~quaden_f_l)) & ((~wr_word_en_ac_l[1]) | (~wr_word_en_ac_l[0]))) & vnw_ary &
	     (way_write_en[n] & word_write_en[n])) begin
	    mem[adr_ac_h][n] <= wr_data[n];
	  end
	  end
