...
assign aclk = gclk;
assign bclk = gclk;
assign array_wr_inhibit = 1'b0;
assign scan_out = 1'b0;
assign aclk_wmr = aclk;

assign wmr_ = rst_wmr_;
assign por_ = rst_por_;
assign pce_ov = tcu_pce_ov;
assign wmr_protect = rst_wmr_protect;
assign cmp_slow_sync_en = ccu_cmp_slow_sync_en;
assign slow_cmp_sync_en = ccu_slow_cmp_sync_en;
