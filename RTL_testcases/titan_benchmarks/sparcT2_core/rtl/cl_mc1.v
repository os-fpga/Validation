...
module cl_mc1_bistl1hdr_12x (
  ...
  assign l1clk = l2clk; //((((l2clk & ~clksel)|(bistclk & clksel)) & ~lce) | se) ;
...
module cl_mc1_cm_com_dff_ ( master, master_l, so, d, l1clk, si, siclk, soclk );
...
module  cl_mc1_l1driver_12x (
   ...
   assign       l1clk = l2clk; //(l2clk & l1en) | se;  // se is async and highest priority
endmodule
