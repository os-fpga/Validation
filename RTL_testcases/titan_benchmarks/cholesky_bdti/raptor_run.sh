...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Chol_Fw_DUT.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Chol_Fw_safe_path.vhd">>raptor_tcl.tcl || echo "" 
    ...
    echo "set_top_module Chol_Fw_DUT">>raptor_tcl.tcl 
