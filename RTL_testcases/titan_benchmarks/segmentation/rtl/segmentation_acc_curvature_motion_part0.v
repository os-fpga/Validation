...
`celldefine
module segmentation_acc_curvature_motion_part0_core (q, ra, ce, clk, d, wa, we);
...
module segmentation_acc_curvature_motion_part0 (
    address0,
    ce0,
    q0,
    we0,
...
segmentation_acc_curvature_motion_part0_core #(
    .READ_PORT_COUNT( 1 ),
    .WRITE_PORT_COUNT( 1 ),
