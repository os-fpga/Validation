...
`celldefine
module segmentation_acc_phi1_0_1_core (q, ra, ce, clk, d, wa, we);
   parameter READ_PORT_COUNT=32'd2;
   parameter WRITE_PORT_COUNT=32'd1;
   parameter DATA_WIDTH=32'd32;
   parameter ADDRESS_WIDTH=32'd10;
   parameter WORD_COUNT=32'd561;
...
module segmentation_acc_phi1_0_1 (
    address0,
    ce0,
    q0,
    we0,
...
parameter AddressRange = 32'd561;
...
segmentation_acc_phi1_0_1_core #(
    .READ_PORT_COUNT( 2 ),
    .WRITE_PORT_COUNT( 1 ),
