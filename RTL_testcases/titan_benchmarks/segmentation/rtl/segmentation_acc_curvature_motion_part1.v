...
`celldefine
module segmentation_acc_curvature_motion_part1_core (q, ra, ce, clk, d, wa, we);
   parameter READ_PORT_COUNT=32'd1;
   parameter WRITE_PORT_COUNT=32'd1;
   parameter DATA_WIDTH=32'd32;
   parameter ADDRESS_WIDTH=32'd13;
   parameter WORD_COUNT=32'd4356;
...
module segmentation_acc_curvature_motion_part1 (
    address0,
    ce0,
    q0,
    we0,
...
parameter AddressRange = 32'd4356;
...
segmentation_acc_curvature_motion_part1_core #(
    .READ_PORT_COUNT( 1 ),
    .WRITE_PORT_COUNT( 1 ),
