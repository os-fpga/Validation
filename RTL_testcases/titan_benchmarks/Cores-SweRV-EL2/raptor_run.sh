...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_def.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/beh_lib.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lib.sv">>raptor_tcl.tcl || echo ""
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dbg.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec_decode_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec_gpr_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec_ib_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec_tlu_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dec_trigger.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_dma_ctrl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_exu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_exu_alu_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_exu_div_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_exu_mul_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_aln_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_bp_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_compress_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_ic_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_iccm_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_ifc_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_mem_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_ifu_tb_memread.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_addrcheck.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_bus_buffer.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_bus_intf.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_clkdomain.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_dccm_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_dccm_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_ecc.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_lsc_ctl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_stbuf.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_lsu_trigger.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_mem.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_pic_ctrl.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_swerv.sv">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/el2_swerv_wrapper.sv">>raptor_tcl.tcl || echo ""
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2012 ./rtl/ram.sv">>raptor_tcl.tcl || echo ""
    ##vary design to design
