...
// ***************************************************************************
`include "sync_data.v"
`include "sync_event.v"
`include "ad_mem_asym.v"
`include "up_axi.v"
`include "2d_transfer.v"
`include "ad_mem.v"
`include "address_generator.v"
`include "axi_dmac_burst_memory.v"
`include "axi_dmac_regmap.v"
`include "axi_dmac_regmap_request.v"
`include "axi_dmac_reset_manager.v"
`include "axi_dmac_resize_dest.v"
`include "axi_dmac_resize_src.v"
`include "axi_dmac_response_manager.v"
`include "axi_dmac_transfer.v"
`include "axi_register_slice.v"
`include "data_mover.v"
`include "dest_axi_mm.v"
`include "dest_axi_stream.v"
`include "dest_fifo_inf.v"
`include "request_arb.v"
`include "request_generator.v"
`include "resp.vh"
`include "response_generator.v"
`include "response_handler.v"
`include "splitter.v"
`include "src_axi_mm.v"
`include "src_axi_stream.v"
`include "src_fifo_inf.v"
`include "sync_bits.v"
`include "sync_gray.v"
`include "util_axis_fifo.v"
`include "util_axis_fifo_address_generator.v"
