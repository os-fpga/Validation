...
design="soc_fpga_ahb_application"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/amba_AHB_Slave.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/top.sv">>raptor_tcl.tcl || echo "" 
    ##vary design to design
    echo "add_simulation_file ./verilator_simulation/verilog.cpp ./verilator_simulation/testbench.sv" >> raptor_tcl.tcl
    echo "set_top_testbench tb_ahb_master_SC">>raptor_tcl.tcl

    echo "set_top_module SOC_FPGA_INTF_AHB_S">>raptor_tcl.tcl 
