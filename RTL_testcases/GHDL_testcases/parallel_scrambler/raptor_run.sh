...
#creating a tcl file to run raptor flow 
    ...
    then
        ...
        for i in ${array[@]}; do
            ...
            echo "add_design_file -VHDL_1993 ./rtl/$temp_abc">>raptor_tcl.tcl
        done
    else
        echo ""
    fi
    ...
    echo "add_simulation_file -VHDL_1993 tb/tb_par_scram.vhd">>raptor_tcl.tcl
    echo "set_top_testbench tb_par_scram">>raptor_tcl.tcl
