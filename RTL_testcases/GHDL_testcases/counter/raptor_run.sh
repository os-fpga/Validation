...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_1993 ./rtl/counter.vhdl">>raptor_tcl.tcl || echo "" 
    # if [ -z "$ip_name" ] 
    # then
    #     array=($(find $directory_path -type f -iname "*.vhdl" -printf "%p ")) 
    #     for i in ${array[@]}; do
    #         abc=$(echo $i | sed 's/\// /g')
    ...
    echo "add_simulation_file -VHDL_1993 tb/counter_tb.vhdl">>raptor_tcl.tcl
    echo "set_top_testbench counter_tb">>raptor_tcl.tcl
    ...
    echo "simulate \"rtl\" \"ghdl\" rtl_sim.vcd">>raptor_tcl.tcl
    ...
    echo "simulate \"gate\" \"ghdl\" post_synth_sim.vcd">>raptor_tcl.tcl
    ...
    # echo "simulate \"pnr\" \"ghdl\" post_route_sim.vcd">>raptor_tcl.tcl
