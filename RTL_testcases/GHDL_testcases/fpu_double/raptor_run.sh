...
ghdl_rtl_sim=true #design_level
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpupack.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/comppack.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_add.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_mul.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_exceptions.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_round.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_sub.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_div.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_2008 ./rtl/fpu_double.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module $design">>raptor_tcl.tcl 
    echo "add_simulation_file -VHDL_2008 tb/fpu_double_TB.vhd">>raptor_tcl.tcl
    echo "set_top_testbench fpu_double_tb">>raptor_tcl.tcl
    ...
    echo "simulation_options \"ghdl\" \"simulation\" \"--stop-time=1000ns\"">>raptor_tcl.tcl
    echo "simulate \"rtl\" \"ghdl\" rtl_sim.fst">>raptor_tcl.tcl
