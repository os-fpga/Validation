...
#creating a tcl file to run raptor flow 
    ...
    then
        ...
        for i in ${array[@]}; do
            ...
            echo "add_design_file -VHDL_2000 rtl/$temp_abc">>raptor_tcl.tcl
        done
    else
        echo ""
    fi
    ...
    echo "add_simulation_file -VHDL_2000 tb/dec3x8_concurrent_test.vhd">>raptor_tcl.tcl
    echo "set_top_testbench dec3x8_concurrent_test">>raptor_tcl.tcl
