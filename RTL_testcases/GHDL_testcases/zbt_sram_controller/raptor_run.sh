...
#creating a tcl file to run raptor flow 
    ...
    then
        ...
        for i in ${array[@]}; do
            ...
            echo "add_design_file -VHDL_2008 ./rtl/$temp_abc">>raptor_tcl.tcl
        done
    else
        echo ""
    fi
    ...
    echo "add_simulation_file -VHDL_2008 tb/tb_zbt_top.vhd">>raptor_tcl.tcl
    echo "set_top_testbench tb_zbt_top_vhd">>raptor_tcl.tcl
