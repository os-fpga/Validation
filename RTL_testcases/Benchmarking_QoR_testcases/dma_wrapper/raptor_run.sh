...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/DMA_DEFINE.vh">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/DMA_FIX_DEFINE.vh">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_ahbdec.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_ahbmst.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_ahbmux.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_ahbslv.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_chrf.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_chsel.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_ctlrf.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_engine.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_fifo.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_rrarb.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/dma_wrapper.v">>raptor_tcl.tcl || echo ""
    ##vary design to design
