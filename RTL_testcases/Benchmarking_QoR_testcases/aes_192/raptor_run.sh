...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/table.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/round.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/aes_192.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design
