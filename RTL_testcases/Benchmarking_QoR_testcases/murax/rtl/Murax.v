...
module StreamFifo (
  ...
  wire [3:0] _zz_11;
  reg _zz_1=0;
  reg pushPtr_willIncrement=0;
  reg pushPtr_willClear=0;
  reg[3:0] pushPtr_valueNext=0;
  reg[3:0] pushPtr_value=0;
  wire  pushPtr_willOverflowIfInc;
  wire  pushPtr_willOverflow;
  reg popPtr_willIncrement=0;
  reg popPtr_willClear=0;
  reg[3:0] popPtr_valueNext=0;
  reg[3:0] popPtr_value=0;
  wire  popPtr_willOverflowIfInc;
  wire  popPtr_willOverflow;
  wire  ptrMatch;
  reg risingOccupancy=0;
  wire  pushing;
  wire  popping;
  wire  empty;
  wire  full;
...
module VexRiscv (
  ...
  reg prefetch_arbitration_haltItself=0;
  reg prefetch_arbitration_haltByOther=0;
  reg prefetch_arbitration_removeIt=0;
  wire  prefetch_arbitration_flushAll;
  wire  prefetch_arbitration_redoIt;
  reg prefetch_arbitration_isValid=0;
  ...
  reg fetch_arbitration_haltItself=0;
  wire  fetch_arbitration_haltByOther;
  reg fetch_arbitration_removeIt=0;
  wire  fetch_arbitration_flushAll;
  wire  fetch_arbitration_redoIt;
  reg fetch_arbitration_isValid=0;
  ...
  reg execute_arbitration_flushAll=0;
  ...
  wire [1:0] _zz_79;
  wire  _zz_80;
  reg prefetch_IBusSimplePlugin_pendingCmd=0;
  reg _zz_81=0;
  reg[31:0] _zz_82=0;
  reg[31:0] _zz_83=0;
  reg[3:0] _zz_84=0;
  wire [3:0] execute_DBusSimplePlugin_formalMask;
  reg[31:0] writeBack_DBusSimplePlugin_rspShifted=0;
  wire  _zz_85;
  reg[31:0] _zz_86=0;
  wire  _zz_87;
  reg[31:0] _zz_88=0;
  reg[31:0] writeBack_DBusSimplePlugin_rspFormated=0;
  ...
  reg CsrPlugin_pipelineLiberator_enable=0;
  ...
  reg[31:0] execute_CsrPlugin_readData=0;
  reg execute_CsrPlugin_readDataRegValid=0;
  reg[31:0] execute_CsrPlugin_writeData=0;
  ...
  reg execute_LightShifterPlugin_isActive=0;
  wire  execute_LightShifterPlugin_isShift;
  reg[4:0] execute_LightShifterPlugin_amplitudeReg=0;
  ...
  reg DebugPlugin_insertDecodeInstruction=0;
  ...
  reg _zz_131=0;
  reg _zz_132=0;
  reg decode_to_execute_IS_EBREAK=0;
  reg[31:0] prefetch_to_fetch_PC=0;
  reg[31:0] fetch_to_decode_PC=0;
  ...
  reg[31:0] decode_to_execute_SRC2=0;
  ...
  reg[31:0] fetch_to_decode_INSTRUCTION=0;
  ...
  reg[31:0] prefetch_to_fetch_FORMAL_PC_NEXT=0;
  reg[31:0] fetch_to_decode_FORMAL_PC_NEXT=0;
  ...
  reg[1:0] memory_to_writeBack_MEMORY_ADDRESS_LOW=0;
...
module JtagBridge (
  ...
  reg system_rsp_valid=0;
  reg system_rsp_payload_error=0;
  reg[31:0] system_rsp_payload_data=0;
...
module MuraxSimpleBusToApbBridge (
  ...
  reg simpleBusStage_cmd_ready=0;
  ...
  reg simpleBusStage_rsp_valid=0;
...
module MuraxApb3Timer (
  ...
  reg _zz_4=0;
  reg _zz_5=0;
  reg[1:0] timerBBridge_ticksEnable=0;
  reg[0:0] timerBBridge_clearsEnable=0;
...
module Murax (
  ...
  wire [31:0] _zz_109;
  wire [31:0] _zz_110;
  reg resetCtrl_mainClkResetUnbuffered=0;
  reg [5:0] resetCtrl_systemClkResetCounter = (6'b000000);
  wire [5:0] _zz_1;
  reg resetCtrl_mainClkReset=0;
  reg resetCtrl_systemReset=0;
  reg system_timerInterrupt=0;
  reg system_externalInterrupt=0;
  wire  _zz_2;
  reg _zz_3=0;
  reg _zz_4=0;
  reg _zz_5=0;
  ...
  reg system_mainBusDecoder_logic_masterPipelined_cmd_ready=0;
  ...
  reg system_mainBusDecoder_logic_rspPending=0;
  reg system_mainBusDecoder_logic_rspNoHit=0;
  reg[0:0] system_mainBusDecoder_logic_rspSourceId=0;
