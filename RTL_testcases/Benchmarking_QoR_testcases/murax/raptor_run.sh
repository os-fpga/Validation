...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Murax.v">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/murax_symbiflow.v">>raptor_tcl.tcl || echo ""
    ##vary design to design

    echo "set_top_module murax_symbiflow">>raptor_tcl.tcl 
