...
design="accum_output_shifted_saturated"
...
#creating a tcl file to run raptor flow 
    ...
    echo "set_top_testbench co_sim_accum_output_shifted_saturated">>raptor_tcl.tcl
    ...
    echo "exec python3 ../../../../scripts/post_route_script.py $design">>raptor_tcl.tcl
