...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=4 -Ps_count=3 -Pm_top=2 -Pm_base=3 -Pdrop_bad_frame=true -Pbad_frame_value=25 -Pbad_frame_mask=20 -version=v1_0 -out_file $IP_PATH/$design">>raptor_tcl.tcl
