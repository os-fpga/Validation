...
design="axil_interconnect_wrapper"
    ip_name="axil_interconnect"
tool_name="iverilog" 
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=16 -Ps_count=16 -Pdata_width=256 -Paddr_width=32 -out_file $IP_PATH/$design">>raptor_tcl.tcl
