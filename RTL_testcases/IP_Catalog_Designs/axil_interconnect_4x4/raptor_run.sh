...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=4 -Ps_count=4 -Pdata_width=64 -Paddr_width=32 -out_file $IP_PATH/$design">>raptor_tcl.tcl
