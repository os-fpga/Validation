...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=8 -Ps_count=8 -Pdata_width=32 -Paddr_width=32 -out_file $IP_PATH/$design">>raptor_tcl.tcl
