...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=23 -PDEPTH=512 -Pbuiltin_fifo=0 -Psynchronous=0 -Pfull_threshold=1 -Pfull_value=500 -out_file $IP_PATH/$design">>raptor_tcl.tcl
