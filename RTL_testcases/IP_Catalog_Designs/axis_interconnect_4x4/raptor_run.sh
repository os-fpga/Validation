...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=4 -Ps_count=4 -Pdata_width=512 -Plast_en=1 -Pid_en=1 -Pid_width=8 -Pdest_en=1 -Pdest_width=8 -Puser_en=1 -Puser_width=1 -out_file $IP_PATH/$design">>raptor_tcl.tcl
