...
design="vexriscv_cpu_plic_clint"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -version=v1_0 -Pvariant=Cache_MMU_PLIC_CLINT -out_file $IP_PATH/$design">>raptor_tcl.tcl
