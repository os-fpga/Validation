...
design="axis_width_converter_128x8"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pcore_in_width=128 -Pcore_out_width=8 -Pcore_user_width=1024 -Pcore_reverse=0 -out_file ./$design">>raptor_tcl.tcl
