...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pequation=AxB+CxD -Pa_width=10 -Pb_width=15 -Pc_width=12 -Pd_width=8 -Preg_in=1 -Preg_out=0 -out_file ./$design">>raptor_tcl.tcl
