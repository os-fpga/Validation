...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=128 -Paddr_width=16 -Pid_width=32 -Pa_pip_out=1 -Pb_pip_out=1 -Pa_interleave=1 -Pb_interleave=1 -out_file $IP_PATH/$design">>raptor_tcl.tcl
