...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Ps_count=1 -Pm_count=1 -Ps_id_width=1 -Plsb_high_priority=0 -Ptype_round_robin=0 -Pspeedup=5 -Pfifo_depth=32 -version=v1_0 -out_file $IP_PATH/$design">>raptor_tcl.tcl
