...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pa_width=36 -Pb_width=36 -Pfeature=Pipeline -out_file $IP_PATH/$design">>raptor_tcl.tcl
