...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=32 -Pfifo_depth=1024 -out_file $IP_PATH/$design">>raptor_tcl.tcl
