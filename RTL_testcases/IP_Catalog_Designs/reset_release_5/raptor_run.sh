...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pext_reset_width=7 -Pinterconnects=5 -out_file $IP_PATH/$design">>raptor_tcl.tcl
