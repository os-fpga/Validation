...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v2_0" -mod_name $design -Pid_width=1 -Paxi_addr_width=32 -Paxi_data_width=32 -Paxil_addr_width=32 -Paxil_data_width=32 -out_file ./$design">>raptor_tcl.tcl
