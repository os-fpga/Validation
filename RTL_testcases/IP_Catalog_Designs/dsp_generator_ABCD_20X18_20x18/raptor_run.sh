...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pequation=AxB+CxD -Pa_width=20 -Pb_width=18 -Pc_width=20 -Pd_width=18 -Preg_in=0 -Preg_out=1 -out_file ./$design">>raptor_tcl.tcl
