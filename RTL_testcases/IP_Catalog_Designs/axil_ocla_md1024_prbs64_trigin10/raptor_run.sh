...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pmem_depth=1024 -Pno_of_probes=64 -Ptrigger_inputs_en=1 -Pno_of_trigger_inputs=10 -out_file $IP_PATH/$design">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "" || echo "add_design_file $IP_PATH/rapidsilicon/ip/$ip_name/v1_0/$design/src/$design.sv">>raptor_tcl.tcl
