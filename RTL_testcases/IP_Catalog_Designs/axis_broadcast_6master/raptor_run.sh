...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pm_count=6 -Pdata_width=128 -Plast_en=1 -Pid_en=1 -Pid_width=8 -Pdest_en=1 -Pdest_width=8 -Puser_en=1 -Puser_width=1 -out_file ./$design">>raptor_tcl.tcl
