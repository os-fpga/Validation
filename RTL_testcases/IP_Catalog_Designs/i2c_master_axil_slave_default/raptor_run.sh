...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdefault_prescale=1 -Pfixed_prescale=0 -Pcmd_fifo=1 -Pcmd_addr_width=5 -Pwrite_fifo=1 -Pwrite_addr_fifo_width=5 -Pread_fifo=1 -Pread_addr_fifo_width=5 -out_file $IP_PATH/$design">>raptor_tcl.tcl
