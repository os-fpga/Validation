...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Poptimization=Area -Pcoefficients=45,67,101,45.54,-90.23,56 -Pcoefficient_fractional_bits=8 -Pcoefficient_width=20 -out_file $IP_PATH/$design">>raptor_tcl.tcl
