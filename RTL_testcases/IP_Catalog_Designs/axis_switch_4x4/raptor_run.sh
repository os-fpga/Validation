...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pid_en=true -Ptid=true -Ps_id_width=16 -Pm_dest_width=8 -version=v1_0 -out_file ./$design">>raptor_tcl.tcl
