...
design="axis_width_converter_1024x1024"
    ip_name="axis_width_converter"
tool_name="iverilog" 
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pcore_in_width=1024 -Pcore_out_width=1024 -Pcore_user_width=1 -Pcore_reverse=0 -out_file $IP_PATH/$design">>raptor_tcl.tcl
