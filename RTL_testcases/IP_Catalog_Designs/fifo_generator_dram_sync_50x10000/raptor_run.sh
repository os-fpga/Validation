...
design="fifo_dram_sync_50x10000"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=50 -Pdepth=10000 -Pbuiltin_fifo=0 -Psynchronous=1 -Pempty_threshold=1 -Pempty_value=50 -out_file $IP_PATH/$design">>raptor_tcl.tcl
