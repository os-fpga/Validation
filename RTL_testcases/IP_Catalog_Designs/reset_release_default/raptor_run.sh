...
design="reset_release_default"
    ip_name="reset_release"
tool_name="iverilog" 
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pext_reset_width=5 -Pinterconnects=1 -out_file $IP_PATH/$design">>raptor_tcl.tcl
