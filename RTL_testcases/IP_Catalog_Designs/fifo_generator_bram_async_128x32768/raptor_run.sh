...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=128 -Pdepth=32768 -Psynchronous=0 -Pfirst_word_fall_through=1 -out_file $IP_PATH/$design">>raptor_tcl.tcl
