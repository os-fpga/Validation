...
design="priority_encoder_default"
    ip_name="priority_encoder"
tool_name="iverilog" 
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pwidth=4 -Plsb_high_priority=0 -out_file $IP_PATH/$design">>raptor_tcl.tcl
