...
design="axis_pipeline_register_wrapper"
    ip_name="axis_pipeline_register"
tool_name="iverilog" 
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "" || echo  "configure_ip $ip_name"_v1_0" -mod_name $design -Pdata_width=8 -Plast_en=1 -Pid_en=0 -Pid_width=8 -Pdest_en=0 -Pdest_width=8 -Puser_en=1 -Puser_width=1 -Preg_type=Skid_Buffer -Plength=2 -out_file $IP_PATH/$design">>raptor_tcl.tcl
