...
design="dsp_mul_signed_comb_iverilog"
...
add_constraint_file="pin_map.pin" #Sets SDC + location constraints  Constraints: set_pin_loc, set_mode, all SDC Standard commands
