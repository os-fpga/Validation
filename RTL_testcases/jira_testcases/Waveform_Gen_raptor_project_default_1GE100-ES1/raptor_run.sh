...
design="Waveform_Gen_raptor_project_default_1GE100-ES1"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sincos_lut.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/waveform_gen.vhd">>raptor_tcl.tcl || echo ""
    ##vary design to design

    echo "set_top_module waveform_gen">>raptor_tcl.tcl 
