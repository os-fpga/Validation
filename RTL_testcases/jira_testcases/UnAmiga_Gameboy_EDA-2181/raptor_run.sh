...
design="UnAmiga_Gameboy_EDA-2181"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/build_id.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/pll.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/dac.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/gb.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/iram.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/keyboard.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/lcd.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/sdram.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/sprite.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/sprite_sort.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/sprites.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/timer.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/video.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/vram.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/zpram.sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/BROM.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/CharROM/CharROM_ROM.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/ZPUFlex/RTL/zpupkg.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/Firmware/CtrlROM_ROM.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/DualPortRAM_2RW_1Clock_Unreg.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/OnScreenDisplay.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/io_ps2_com.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/spi.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/interrupt_controller.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/CtrlModule.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/T80_Pack.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/GBse.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/CtrlModule/RTL/OSD_Overlay.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/T80.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/T80_ALU.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/T80_MCode.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/t80/T80_Reg.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/gbc_snd.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/menuOSD.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/menuOSD/ZPUFlex/RTL/zpu_core_flex.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Cores/GameBoy/rtl/gb_mist.sv">>raptor_tcl.tcl || echo "" 

    ##vary design to design

    echo "set_top_module gb_mist">>raptor_tcl.tcl 
