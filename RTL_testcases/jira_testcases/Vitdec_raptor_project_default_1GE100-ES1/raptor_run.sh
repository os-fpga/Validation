...
#creating a tcl file to run raptor flow 
    ...
    if [ "$post_synth_sim" == true ]; then 
        ...
        echo "file copy -force $main_path/rtl/rstmem.txt $main_path/results_dir/$design/run_1/synth_1_1/simulate_gate/" >> raptor_tcl.tcl 
    ...
    echo "route">>raptor_tcl.tcl  
        if [ "$post_route_sim" == true ]; then 
            ...
            echo "file copy -force $main_path/rtl/rstmem.txt $main_path/results_dir/$design/run_1/synth_1_1/impl_1_1_1/simulate_pnr/" >> raptor_tcl.tcl
