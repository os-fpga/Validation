...
design="Vitdec_raptor_project_default_1GE100-ES1"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/acs.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/dpram.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/tb_ram.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/viterbi_decoder_r2.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module viterbi_decoder_r2">>raptor_tcl.tcl 
...
[ -f rtl/dpram.v ] && sed -i -e "s|MEM_FILE_PATH|$PWD/rtl|g" rtl/dpram.v
