...
design="video_stream_scalar_EDA-2184"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/scaler.v">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/scaler_sr_top.v">>raptor_tcl.tcl || echo "" 
