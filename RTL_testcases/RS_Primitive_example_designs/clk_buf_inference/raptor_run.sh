...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ifmap_spad.v">>raptor_tcl.tcl || echo "" 
    echo "add_simulation_file ./sim/ifmap_spad_tb.v" >> raptor_tcl.tcl
    ##vary design to design

    echo "set_top_testbench ifmap_spad_tb">>raptor_tcl.tcl
    echo "set_top_module ifmap_spad">>raptor_tcl.tcl 
