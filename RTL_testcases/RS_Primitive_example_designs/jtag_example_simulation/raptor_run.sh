...
design="jtag_example_simulation"
...
#creating a tcl file to run raptor flow 
    ...
    echo "add_simulation_file ./sim/jtag_example_simulation_tb.v" >> raptor_tcl.tcl
    ##vary design to design

    echo "set_top_testbench jtag_example_tb">>raptor_tcl.tcl
