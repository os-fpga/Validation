...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/mult_pipe2.v">>raptor_tcl.tcl || echo "" 
    echo "add_simulation_file ./sim/mult_pipe2_tb.v" >> raptor_tcl.tcl
    ##vary design to design

    echo "set_top_testbench mult_pipe2_tb">>raptor_tcl.tcl
    echo "set_top_module mult_pipe2">>raptor_tcl.tcl 
    echo "synth_options -inferred_io -keep_tribuf">>raptor_tcl.tcl 
