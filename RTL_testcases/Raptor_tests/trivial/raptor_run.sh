...
#creating a tcl file to run raptor flow 
    ...
    echo "architecture k6_frac_N10_tileable_40nm.xml k6_N10_40nm_openfpga.xml">>raptor_tcl.tcl 
    echo "set_macro P1=10  P2=20">>raptor_tcl.tcl 
    ...
    [ -z "$ip_name" ] && echo "add_include_path ./inc/">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_library_path ./rtl">>raptor_tcl.tcl || echo "" 
    # [ -z "$ip_name" ] && echo "add_library_ext .v .sv">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file rtl/test.sv rtl/bottom.sv -SV_2012">>raptor_tcl.tcl || echo ""
    ##vary design to design
