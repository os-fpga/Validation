...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -SV_2009 ./rtl/$design.sv">>raptor_tcl.tcl || echo "" 
    ##vary design to design
    ...
    echo "set_top_testbench param_up_counter">>raptor_tcl.tcl
    echo "simulate rtl verilator counter_rtl.fst">>raptor_tcl.tcl
    ...
    echo "simulate gate verilator counter_gate.fst">>raptor_tcl.tcl
    echo "packing">>raptor_tcl.tcl   
    echo "place">>raptor_tcl.tcl  
    echo "route">>raptor_tcl.tcl  
    echo "simulate pnr verilator counter_pnr.fst">>raptor_tcl.tcl
