...
#creating a tcl file to run raptor flow 
    ...
    echo "add_simulation_file -SV_2012 ./tb/tb.v">>raptor_tcl.tcl
    echo "set_top_testbench tb">>raptor_tcl.tcl
    echo "simulate gate icarus syn_tb_pnr.fst">>raptor_tcl.tcl
    ...
    echo "simulate pnr icarus syn_tb_pnr.fst">>raptor_tcl.tcl   
