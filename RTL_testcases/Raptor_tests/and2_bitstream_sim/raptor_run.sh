...
bitstream="enable_simulation" #force
...
#creating a tcl file to run raptor flow 
    ...
    echo "simulate \"rtl\" \"icarus\" dump.fst">>raptor_tcl.tcl
    ...
    echo "simulate \"gate\" \"icarus\" dump.fst">>raptor_tcl.tcl 
    ...
    echo "add_simulation_file SRC/CustomModules/rs_mmff.v SRC/cells.v">>raptor_tcl.tcl
    echo "add_library_path ../../Castor_V2/IPs/openfpga-pd-castor-rs/k6n8_TSMC16nm_7.5T/FPGA10x8_dp_castor_pnr/release/FPGA10x8_dp_castor_verilog/SRC/submodules/">>raptor_tcl.tcl
