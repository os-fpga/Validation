...
add_constraint_file="output_ddr.sdc" #Sets SDC + location constraints  Constraints: set_pin_loc, set_mode, all SDC Standard commands
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "read_netlist rtl/output_ddr_gate.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design
