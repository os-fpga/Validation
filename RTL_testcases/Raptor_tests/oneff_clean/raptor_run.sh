...
#creating a tcl file to run raptor flow 
    ...
    echo "# Design">>raptor_tcl.tcl 
    echo "create_design oneff_gemini_clean">>raptor_tcl.tcl 
    echo "add_design_file -SV_2009 rtl/dut.v">>raptor_tcl.tcl 
    echo "set_top_module dut">>raptor_tcl.tcl 
    echo "add_constraint_file pin_mapping.pin">>raptor_tcl.tcl 
    echo "add_constraint_file constraints.sdc">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Testbench">>raptor_tcl.tcl 
    echo "add_simulation_file -SV_2012 rtl/syn_tb.v">>raptor_tcl.tcl 
    echo "add_simulation_file sim_main.cpp">>raptor_tcl.tcl 
    echo "set_top_testbench syn_tb">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Device target">>raptor_tcl.tcl 
    echo "target_device GEMINI_COMPACT_10x8">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Compilation/Simulation">>raptor_tcl.tcl 
    echo "analyze">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# RTL Simulation">>raptor_tcl.tcl 
    echo "simulate rtl verilator syn_tb_rtl.fst">>raptor_tcl.tcl 
    echo "set projName oneff_gemini_clean">>raptor_tcl.tcl 
    echo "set basePath [pwd]/\$projName/run_1/synth_1_1">>raptor_tcl.tcl 
    echo "set simRtlPath \$basePath/simulate_rtl">>raptor_tcl.tcl 
    echo "set exists [file exists \$simRtlPath/syn_tb_rtl.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 1} { puts "syn_tb_rtl.fst does not exists"; exit 1 }">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Synthesis">>raptor_tcl.tcl 
    echo "synthesize delay">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Post-Synthesis gate-level Simulation">>raptor_tcl.tcl 
    echo "simulate gate verilator syn_tb_gate.fst">>raptor_tcl.tcl 
    echo "set simGatePath \$basePath/simulate_gate">>raptor_tcl.tcl 
    echo "set exists [file exists \$simGatePath/syn_tb_gate.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 1} { puts "syn_tb_gate.fst does not exists"; exit 1 }">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Pack/Place/Route">>raptor_tcl.tcl 
    echo "packing">>raptor_tcl.tcl 
    echo "place">>raptor_tcl.tcl 
    echo "route">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Post-Route Simulation">>raptor_tcl.tcl 
    echo "simulate pnr verilator syn_tb_pnr.fst">>raptor_tcl.tcl 
    echo "set simPnrPath \$basePath/simulate_pnr">>raptor_tcl.tcl 
    echo "set exists [file exists \$simPnrPath/syn_tb_pnr.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 1} { puts "syn_tb_pnr.fst does not exists"; exit 1 }">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Static Timing Analysis">>raptor_tcl.tcl 
    echo "sta opensta">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# Bitstream Generation">>raptor_tcl.tcl 
    echo "bitstream">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# bitstream simulation">>raptor_tcl.tcl 
    echo "#simulate bitstream_bd syn_tb_bitstream.fst">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "#clean all">>raptor_tcl.tcl 
    echo "simulate rtl  clean">>raptor_tcl.tcl 
    echo "simulate gate clean">>raptor_tcl.tcl 
    echo "simulate pnr clean">>raptor_tcl.tcl 
    echo "#simulate bitstream_bd clean">>raptor_tcl.tcl 
    echo "">>raptor_tcl.tcl 
    echo "# check is files exist">>raptor_tcl.tcl 
    echo "set exists [file exists \$simRtlPath/syn_tb_rtl.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 0} { puts "syn_tb_rtl.fst exists"; exit 1 }">>raptor_tcl.tcl 
    echo "set exists [file exists \$simGatePath/syn_tb_gate.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 0} { puts "syn_tb_gate.fst exists"; exit 1 }">>raptor_tcl.tcl 
    echo "set exists [file exists \$simPnrPath/syn_tb_pnr.fst]">>raptor_tcl.tcl 
    echo "if {\$exists != 0} { puts "syn_tb_pnr.fst exists"; exit 1 }">>raptor_tcl.tcl 
    echo "#set exists [file exists \$path/syn_tb_bitstream.fst]">>raptor_tcl.tcl 
    echo "#if {\$exists != 0} { puts "syn_tb_bitstream.fst exists"; exit 1 }">>raptor_tcl.tcl 
    ...
    # [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/and2.v">>raptor_tcl.tcl || echo "" 
    # ##vary design to design

    # echo "set_top_module and2">>raptor_tcl.tcl 
