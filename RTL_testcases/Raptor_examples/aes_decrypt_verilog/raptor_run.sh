...
#creating a tcl file to run raptor flow 
    ...
    echo "add_design_file -SV_2012 ./rtl/aes_decrypt128.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/aes_decrypt256.sv ">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/gfmul.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvMixCol_slice.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvSbox.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvSubBytes.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/KeyExpand192.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/KschBuffer.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/Sbox.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/aes_decrypt192.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/decrypt.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvAddRoundKey.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvMixColumns.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/InvShiftRows.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/KeyExpand128.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/KeyExpand256.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/RotWord.sv">>raptor_tcl.tcl
    echo "add_design_file -SV_2012 ./rtl/SubWord.sv">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/decrypt_top.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module decrypt_top">>raptor_tcl.tcl 
