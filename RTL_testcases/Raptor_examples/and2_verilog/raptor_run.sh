...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -V_2001 ./rtl/$design.v">>raptor_tcl.tcl || echo "" 
    ##vary design to design
    ...
    ##vary design to design
    echo "# Simulation">>raptor_tcl.tcl
    echo "add_simulation_file ./rtl/testbench_and2.v">>raptor_tcl.tcl
    echo "set_top_testbench testbench_and2">>raptor_tcl.tcl
    ...
    echo "# Post PnR Simulation">>raptor_tcl.tcl
