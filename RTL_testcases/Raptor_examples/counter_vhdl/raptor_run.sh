...
pnr_netlist_lang="vhdl" #blif, edif, verilog
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -VHDL_1993 ./rtl/UP_COUNTER.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module UP_COUNTER">>raptor_tcl.tcl 

    ##vary design to design
    [ -z "$add_constraint_file" ] && echo "" || echo "add_constraint_file $add_constraint_file">>raptor_tcl.tcl #design_level
    echo "add_simulation_file -VHDL_1993 ./rtl/testbench.vhd">>raptor_tcl.tcl
    echo "set_top_testbench tb_counters">>raptor_tcl.tcl

	echo "analyze">>raptor_tcl.tcl
    echo "simulation_options \"ghdl\" \"simulation\" \"--stop-time=1000ns\"">>raptor_tcl.tcl
    echo "simulate \"rtl\" \"ghdl\" syn_tb_rtl.fst">>raptor_tcl.tcl
    ...
    echo "simulate \"gate\" \"ghdl\" syn_tb_gate.fst">>raptor_tcl.tcl
