...
design="ip_test"
ip_name="axis_width_converter" #design_level
...
#creating a tcl file to run raptor flow 
    ...
    echo "add_design_file ./rtl/use_ip.v">>raptor_tcl.tcl || echo "" 

    ##vary design to design
    [ -z "$add_constraint_file" ] && echo "" || echo "add_constraint_file $add_constraint_file">>raptor_tcl.tcl #design_level

    echo "set_top_module use_ip">>raptor_tcl.tcl 

    ##vary design to design
    [ -z "$ip_name" ] && echo "" || echo "configure_ip $ip_name"_v1_0" -mod_name conv32_16 -version 1.0 -Pcore_in_width=32 -Pcore_out_width=16 -Pcore_reverse=0 -out_file rs_ips/conv32_16.v">>raptor_tcl.tcl
    ...
    [ -z "$ip_name" ] && echo "" || echo "add_design_file ./rs_ips/rapidsilicon/ip/$ip_name/v1_0/conv32_16/src/conv32_16.v">>raptor_tcl.tcl
    ...
    [ -z "$strategy" ] && echo "" || echo "synth $strategy">>raptor_tcl.tcl  
