...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/QuadratureDecoder.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/QuadratureCounter.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module QuadratureCounterPorts">>raptor_tcl.tcl 
