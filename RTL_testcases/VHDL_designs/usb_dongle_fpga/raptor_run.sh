...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/byte_scan_mux.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fifo.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fifo_inst.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/flsh_if.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/led_coder.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/led_sys.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/lpc_byte.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/pc_serializer.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb2mem.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/design_top_thincandbg.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module design_top_thincandbg">>raptor_tcl.tcl 
