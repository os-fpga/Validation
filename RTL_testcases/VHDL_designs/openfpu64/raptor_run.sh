...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpu_package.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/eis_helpers.vhd">>raptor_tcl.tcl || echo ""  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fpu_mul_single.vhd">>raptor_tcl.tcl || echo "" 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/openfpu64.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design
