...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Encoder/8b10_enc.vhd">>raptor_tcl.tcl
    # if [ -z "$ip_name" ] && echo "add_design_file ./rtl/$temp_abc">>raptor_tcl.tcl
    # then
    ...
    echo "set_top_module enc_8b10b">>raptor_tcl.tcl 
