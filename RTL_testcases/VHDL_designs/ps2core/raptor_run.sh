...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ps2.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ps2_wishbone.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module ps2_wb">>raptor_tcl.tcl 
