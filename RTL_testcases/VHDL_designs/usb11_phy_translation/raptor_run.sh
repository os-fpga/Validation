...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_rx_phy.vhdl">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_rx_phy_60MHz.vhdl">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_tx_phy.vhdl">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/usb_phy.vhdl">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module usb_phy">>raptor_tcl.tcl 
