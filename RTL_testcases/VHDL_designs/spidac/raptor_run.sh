...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/DAC_Control.vhd">>raptor_tcl.tcl 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/DAC_TOP.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module DAC_TOP">>raptor_tcl.tcl 
