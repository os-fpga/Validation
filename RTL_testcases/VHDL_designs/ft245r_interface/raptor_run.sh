...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/e1_frm/ft245rl_interface.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module ft245rl_interface">>raptor_tcl.tcl 
