...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_fifo_async16_rcsr_wf.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_fifo_async16_sr.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_uart_16550.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_uart_16550_amba_apb_wrapper.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_uart_16550_wb_wrapper.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_uart_Rx_8bit.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gh_uart_16550_101307/uart/gh_uart_Tx_8bit.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module gh_uart_16550_amba_apb_wrapper">>raptor_tcl.tcl 
