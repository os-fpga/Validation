...
#creating a tcl file to run raptor flow 
    ...
    then
        ...
        # done
        echo "add_design_file rtl/control_i.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/control_slip.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/rom_cos.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/rom_cosi.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/alfft_core_sli.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/alfft_core_slip.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/ramb16_s36_s36.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/ramb16_s18_s18.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/ram2x_2.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/ram1x_2.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/fftdpath.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/fftdpathi.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/denorm.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/fft_filtr2.vhd">>raptor_tcl.tcl
    else
        echo ""
    fi
    ##vary design to design

    echo "set_top_module FFT_FILTER2">>raptor_tcl.tcl 
