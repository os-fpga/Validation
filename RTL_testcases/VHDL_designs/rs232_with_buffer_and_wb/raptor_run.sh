...
design="rs232_with_buffer_and_wb"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_rx.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_rx_fifo.vhd">>raptor_tcl.tcl || echo ""  
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_tx.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_tx_fifo.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_wb.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_top.vhd">>raptor_tcl.tcl || echo ""
    ##vary design to design

    echo "set_top_module uart_top">>raptor_tcl.tcl 
