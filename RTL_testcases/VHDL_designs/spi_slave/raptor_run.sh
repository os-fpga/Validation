...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/PCK_CRC32_D32.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/PCK_CRC8_D8.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/bin2gray.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/crc_core.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/crc_gen.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fifo.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/fifo_prog_flags.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gray2bin.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/gray_adder.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/irq_ctl.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/opb_m_if.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/opb_spi_slave.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/opb_spi_slave_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ram.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/shift_register.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/opb_if.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module opb_spi_slave">>raptor_tcl.tcl 
