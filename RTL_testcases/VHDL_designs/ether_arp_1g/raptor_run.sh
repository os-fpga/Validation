...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/arp_package.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/edge_detector.vhd">>raptor_tcl.tcl || echo ""
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/arp_responder.vhd">>raptor_tcl.tcl || echo ""
    ##vary design to design
