...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/WrimmPackage.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Wrimm.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module Wrimm">>raptor_tcl.tcl 
