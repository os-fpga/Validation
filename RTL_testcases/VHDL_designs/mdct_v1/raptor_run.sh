...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/DCT1D.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/DCT2D.vhd">>raptor_tcl.tcl || echo "" 
