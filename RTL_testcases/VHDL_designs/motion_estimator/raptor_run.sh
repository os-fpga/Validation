...
#creating a tcl file to run raptor flow 
    ...
    if [ -z "$ip_name" ] 
    then
        # array=($(find $directory_path -type f -iname "*.vhd" -printf "%p ")) 
        # for i in ${array[@]}; do
        #     abc=$(echo $i | sed 's/\// /g')
        #     temp_abc=$(echo $abc | rev | cut -d " " -f1 | rev)
        #     echo "add_design_file ./rtl/$temp_abc">>raptor_tcl.tcl
        # done
        echo "add_design_file rtl/ram_dual_port.v">>raptor_tcl.tcl
        echo "add_design_file rtl/config.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/forward_engine.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/concatenate64.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/current_macroblock_memory64.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/distance_engine64.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/dual_port_component.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/range_checker.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/me_control_unit.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/me_engine.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/phy_address.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/point_memory.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/program_memory.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/sad_selector.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/reg_memory_dp.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/register_file.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/reference_memory64_remap.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/reference_macroblock_memory64.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/reference_memory64_dp_large.vhd">>raptor_tcl.tcl
        echo "add_design_file rtl/me_top.vhd">>raptor_tcl.tcl
    else
        echo ""
    fi
    ##vary design to design

    echo "set_top_module me_top">>raptor_tcl.tcl 
