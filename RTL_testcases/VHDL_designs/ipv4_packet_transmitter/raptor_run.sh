...
design="ipv4_packet_transmitter"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/ALLOW_ZERO_UDP_CHECKSUM.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/COUNTER_11B_EN.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/COUNTER_6B_LUT_FIFO_MODE.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/ENABLE_USER_DATA_TRANSMISSION.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/IPV4_LUT_INDEXER.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/OVERRIDE_LUT_CONTROL.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/REG_16B_WREN.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/TARGET_EOF.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/comp_11b_equal.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/comp_6b_equal.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/dist_mem_64x8.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/IPv4_PACKET_TRANSMITTER/IPV4_PACKET_TRANSMITTER.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module IPV4_PACKET_TRANSMITTER">>raptor_tcl.tcl 
