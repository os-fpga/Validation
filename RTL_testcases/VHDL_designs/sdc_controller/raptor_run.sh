...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/block_ram_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/convert_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/dds_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/fifo_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/sd_host_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/signal_conditioning_pack.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/sdc_controller_VHDL/ucrc_pack.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module sd_cmd_host">>raptor_tcl.tcl 
