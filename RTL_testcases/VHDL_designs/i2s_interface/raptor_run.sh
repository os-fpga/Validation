...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/tx_i2s_pack.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/i2s_codec.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/i2s_version.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/tx_i2s_tops.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/tx_i2s_wbd.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/tx_i2s_topm.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module tx_i2s_topm">>raptor_tcl.tcl 
