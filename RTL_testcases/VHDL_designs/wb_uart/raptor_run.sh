...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_clock_div.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_counter.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_edge_detect.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_fifo.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_input_filter.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_input_sync.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/slib_mv_filter.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/txt_util.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_baudgen.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_interrupt.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_receiver.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/uart_transmitter.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wb8_uart_package.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wb8_uart_transactor.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/wb8_uart_16750.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module uart_16750">>raptor_tcl.tcl 
