...
design="adat_optical_feed_forward_receiver"
...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/ADAT_receiver.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module ADAT_receiver">>raptor_tcl.tcl 
