...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/grp_debouncer.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/spi_loopback.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/spi_loopback_test.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/spi_master.vhd">>raptor_tcl.tcl
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/spi_slave.vhd">>raptor_tcl.tcl
    ##vary design to design

    echo "set_top_module spi_slave">>raptor_tcl.tcl 
