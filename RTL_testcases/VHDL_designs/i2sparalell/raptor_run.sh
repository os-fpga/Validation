...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/AnalogBus.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/Clocks.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/Tx/I2SParalell.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module I2SParalellPorts">>raptor_tcl.tcl 
