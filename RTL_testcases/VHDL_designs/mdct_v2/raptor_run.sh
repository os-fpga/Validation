...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/MDCT_PKG.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work zaheer ./rtl/MDCT_PKG_ONE.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work zaheer ./rtl/DCT1D.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work zaheer ./rtl/DCT2D.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/ROMO.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/DBUFCTL.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/RAM.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/ROME.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file -work avinash ./rtl/MDCT.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module $design -work avinash">>raptor_tcl.tcl 
