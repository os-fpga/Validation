...
#creating a tcl file to run raptor flow 
    ...
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/bram.vhd">>raptor_tcl.tcl || echo "" 
    [ -z "$ip_name" ] && echo "add_design_file ./rtl/JTAG_Ctrl_Master.vhd">>raptor_tcl.tcl || echo "" 
    ##vary design to design

    echo "set_top_module JTAG_Ctrl_Master">>raptor_tcl.tcl 
