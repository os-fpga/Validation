...
add_constraint_file="flop2flop.sdc" #Sets SDC + location constraints  Constraints: set_pin_loc, set_mode, all SDC Standard commands
...
pnr_options="--read_vpr_constraints flop2flop_north.vpr.xml"  #VPR options
