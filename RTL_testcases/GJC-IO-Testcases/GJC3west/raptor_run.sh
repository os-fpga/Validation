...
add_constraint_file="flop2flop2flop.sdc" #Sets SDC + location constraints  Constraints: set_pin_loc, set_mode, all SDC Standard commands
...
pnr_options="--read_vpr_constraints flop2flop_west.vpr.xml"  #VPR options
...
#creating a tcl file to run raptor flow 
    ...
    echo "target_device 1GE100-ES1">>raptor_tcl.tcl 
