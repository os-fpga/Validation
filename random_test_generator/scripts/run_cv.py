...
exec(open(CV_ROOT+'/random_test_generator/scripts/random_testcase_generator/random_gen.py').read())
...
if (os.path.exists(CV_ROOT+"/random_test_generator/"+args.json)):
  with open(CV_ROOT+"/random_test_generator/"+args.json) as file:
...
TOOL_CONF_TEMP = CV_ROOT+"/random_test_generator/"+args.json
